...
<%@ page import='org.jaffa.applications.jaffa.modules.admin.components.menunavigation.ui.MenuNavigationComponent' %>
...
<!-- Start of '/jaffa/admin/menunavigation/main.jsp' -->
...
<!-- End of '/jaffa/admin/menunavigation/main.jsp' -->
