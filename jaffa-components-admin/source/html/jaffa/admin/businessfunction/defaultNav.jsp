...
<!-- start of '/jaffa/admin/roleseditor/defaultnav.jsp' -->
<table width="100%" class="defaultNav">
  <tr>
    ...
    <td width="100%" align="right" valign="middle"><Portlet:Button  field='Refresh' type='link' label='[label.Jaffa.Widgets.Button.Refresh]'/></td>
    <td align="right" width="1%"><Portlet:Button field='Refresh' image='jaffa/imgs/icons/nextArrows.gif' label='[label.Jaffa.Widgets.Button.Refresh]'/></td>
  </tr>
</table>
<!-- End of '/jaffa/admin/roleseditor/defaultNav.jsp' -->
