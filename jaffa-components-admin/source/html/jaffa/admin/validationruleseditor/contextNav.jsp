...
<!-- Start of '/jaffa/admin/validationruleseditor/contextNav.jsp' -->
<TABLE cellpadding='0' cellspacing='0' align='center' class='contextNav'>
  <TR>
    <TD valign='bottom' width='100%'>
      <table class='contextNavHeader' width='100%'>
        <TR>
          <TD class='contextNavTitle'><Portlet:Label key='label.Jaffa.Widgets.Button.Action'/></TD>
...
<!-- End of '/jaffa/admin/validationruleseditor/contextNav.jsp' -->
