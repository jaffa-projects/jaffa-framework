...
<!-- Start of '/jaffa/admin/roleseditor/contextNav.jsp' -->
    ...
    <td>
      ...
      <table class='contextNavBody' cellspacing='0' cellpadding='0' width='100%'>
        ...
        <tr>
          <td>
            <img src="jaffa/imgs/icons/refresh.gif">
            <Portlet:Button  field='CheckPolicy' type='link' label='[label.Jaffa.Admin.CheckPolicy]' preprocess='false'/>
          </td>
        </tr>
        <tr>
          <td>
...
<!-- End of '/jaffa/admin/roleseditor/contextNav.jsp' -->
