...
// .//GEN-LAST:imports
// .//GEN-BEGIN:2_be
/** This class has the meta information for the Part persistent class.
 */
public class PartMeta {
    ...
    private static String m_labelToken = "[label.App1.Catalog.Part]";
    ...
    public static final FieldMetaData META_PART = new StringFieldMetaData(PART, "[label.App1.Catalog.Part.Part]", Boolean.TRUE, null, new Integer(50), FieldMetaData.UPPER_CASE);

    /** A constant which holds the meta information for the Noun field.*/
    public static final FieldMetaData META_NOUN = new StringFieldMetaData(NOUN, "[label.App1.Catalog.Part.Noun]", Boolean.TRUE, null, new Integer(40), FieldMetaData.UPPER_CASE);

    /** A constant which holds the meta information for the CategoryInstrument field.*/
    public static final FieldMetaData META_CATEGORY_INSTRUMENT = new StringFieldMetaData(CATEGORY_INSTRUMENT, "[label.App1.Catalog.Part.CategoryInstrument]", Boolean.FALSE, null, new Integer(20), FieldMetaData.UPPER_CASE);
    ...
    static {
        ...
        m_mandatoryFields.add(META_NOUN);
    }
