...
// .//GEN-LAST:imports
// .//GEN-BEGIN:2_be
/** This class has the meta information for the PartPicture persistent class.
 */
public class PartPictureMeta {
    
    // domain-object class name
    private static String m_name = "org.jaffa.persistence.domainobjects.PartPicture";

    // token to be used for getting the label for the domain-object
    private static String m_labelToken = "[label.App1.Catalog.PartPicture]";
    ...
    public static final FieldMetaData META_PART = new StringFieldMetaData(PART, "[label.App1.Catalog.PartPicture.Part]", Boolean.TRUE, null, new Integer(50), FieldMetaData.UPPER_CASE);

    /** A constant which holds the meta information for the SmallPicture field.*/
    public static final FieldMetaData META_SMALL_PICTURE = new RawFieldMetaData(SMALL_PICTURE, "[label.App1.Catalog.PartPicture.SmallPicture]", Boolean.FALSE);

    /** A constant which holds the meta information for the Picture field.*/
    public static final FieldMetaData META_PICTURE = new RawFieldMetaData(PICTURE, "[label.App1.Catalog.PartPicture.Picture]", Boolean.FALSE);
    ...
    static {
        ...
        m_fieldMap.put(SMALL_PICTURE, META_SMALL_PICTURE);
