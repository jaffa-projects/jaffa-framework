...
<!-- Start of '/html/tiles/object_finder_2_0/contextNav.jsp' -->
      ...
      <table class='contextNavBody' cellspacing='0' cellpadding='0' width='100%'>
        ...
        <tr>
          <td>
            ...
            <logic:equal name='contextNavLink' value='Select'>
	    <logic:equal name='inMultiSelectLookupMode' value='true'>			        	
	    <img src="jaffa/imgs/icons/select.gif">
	    <Portlet:Button field='MultiSelect' label='[label.Jaffa.Widgets.Button.Select]' type='link'/>
	    </logic:equal>
	    </logic:equal>
...
<!-- End of '/jaffa/jsp/tiles/object_lookup_2_0/contextNav.jsp' -->
