...
tableSortUkBrowserVar = function() {
...
function sortColumn(e) {
  ...
  if (tableSortUkBrowserVar.ie5)
    tmp = e.srcElement;
  else if (tableSortUkBrowserVar.dom)
    tmp = e.target;
...
function getInnerText(el) {
  if (tableSortUkBrowserVar.ie5) return el.innerText;    //Not needed but it is faster
  var str = "";
