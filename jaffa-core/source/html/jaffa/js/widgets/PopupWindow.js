  ...
  else
  {
    if (this.popupWindow == null || this.popupWindow.closed)
    {
      this.popupWindow = window.open("about:blank", "window_" + anchorname,
        "toolbar=no,location=no,status=no,menubar=no,scrollbars=auto,resizable,alwaysRaised,dependent,titlebar=no,width=" + this.width + ",height=" + this.height + ",screenX=" + this.x + ",left=" + this.x + ",screenY=" + this.y + ",top=" + this.y + "");
    }
    this.refresh();
  }
}
  ...
  if (this.divName != null)
  {
    if (this.use_gebi)
    {
      if (document.getElementById(this.divName) != null && document.getElementById(this.divName).style.visibility == "visible")
      {
        ...
        document.all.calendardd.disabled = true;
      }
    }
    else if (this.use_css)
    {
