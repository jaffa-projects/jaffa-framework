 ...
 ******************************************************/
package org.jaffa.applications.test.modules.time.components.usertimeentrylookup.tx;
...
// .//GEN-LAST:_imports
// .//GEN-BEGIN:_2_be
/** Lookup for UserTimeEntry objects.
*/
public class UserTimeEntryLookupTx implements IUserTimeEntryLookup {

    private static Logger log = Logger.getLogger(UserTimeEntryLookupTx.class);
     ...
     */
    public UserTimeEntryLookupOutDto find(UserTimeEntryLookupInDto input)
    ...
    private UserTimeEntryLookupOutDto buildDto(UOW uow, Collection results, UserTimeEntryLookupInDto input)
    throws UOWException {
