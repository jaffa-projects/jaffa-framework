...
// .//GEN-LAST:_imports
// .//GEN-BEGIN:_2_be
/** The Action class for handling events related to UserTimeEntryFinder.
 */
public class UserTimeEntryFinderAction extends FinderAction {
    private static final Logger log = Logger.getLogger(UserTimeEntryFinderAction.class);
