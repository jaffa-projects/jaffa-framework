 ...
 */
public class UserTimeEntryViewerAction extends ActionBase {

    private static final Logger log = Logger.getLogger(UserTimeEntryViewerAction.class);
    ...
    public FormKey do_Close_Clicked() {
        ...
        return ((UserTimeEntryViewerForm) form).getComponent().quitAndReturnToCallingScreen();
    }
