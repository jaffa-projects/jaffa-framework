...
// .//GEN-LAST:_imports
// .//GEN-BEGIN:_2_be
/** The output for the UserTimeEntryLookup.
 */
public class UserTimeEntryLookupOutDto extends FinderOutDto {

    /** Holds an array of rows to be returned. */
    private List rows;

    /** Default Constructor.*/    
    public UserTimeEntryLookupOutDto() {
        rows = new ArrayList();
    }
    ...
    public UserTimeEntryLookupOutRowDto getRows(int index) {
        ...
        return (UserTimeEntryLookupOutRowDto) rows.get(index);
    }
    ...
    public UserTimeEntryLookupOutRowDto[] getRows() {
        return (UserTimeEntryLookupOutRowDto[]) rows.toArray(new UserTimeEntryLookupOutRowDto[0]);
    }
