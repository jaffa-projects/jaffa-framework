 ...
 ******************************************************/
package org.jaffa.applications.test.modules.time.components.usertimeentryfinder.ui;
...
// .//GEN-LAST:_imports
// .//GEN-BEGIN:_2_be
/** The FormBean class to support UserTimeEntryFinder.
 */
public class UserTimeEntryFinderForm extends FinderForm {

    private static Logger log = Logger.getLogger(UserTimeEntryFinderForm.class);
    // .//GEN-END:_2_be
    ...
    public String getUserName() {
        return ( (UserTimeEntryFinderComponent) getComponent() ).getUserName();
    }
    ...
    public void setUserName(String userName) {
        ( (UserTimeEntryFinderComponent) getComponent() ).setUserName(userName);
    }
    ...
    public String getUserNameDd() {
        return ( (UserTimeEntryFinderComponent) getComponent() ).getUserNameDd();
    }
    ...
    public void setUserNameDd(String userNameDd) {
        ( (UserTimeEntryFinderComponent) getComponent() ).setUserNameDd(userNameDd);
    }
    ...
    public String getProjectCode() {
        return ( (UserTimeEntryFinderComponent) getComponent() ).getProjectCode();
    }
    ...
    public void setProjectCode(String projectCode) {
        ( (UserTimeEntryFinderComponent) getComponent() ).setProjectCode(projectCode);
    }
    ...
    public String getProjectCodeDd() {
        return ( (UserTimeEntryFinderComponent) getComponent() ).getProjectCodeDd();
    }
    ...
    public void setProjectCodeDd(String projectCodeDd) {
        ( (UserTimeEntryFinderComponent) getComponent() ).setProjectCodeDd(projectCodeDd);
    }
    ...
    public String getActivity() {
        return ( (UserTimeEntryFinderComponent) getComponent() ).getActivity();
    }
    ...
    public void setActivity(String activity) {
        ( (UserTimeEntryFinderComponent) getComponent() ).setActivity(activity);
    }
    ...
    public String getActivityDd() {
        return ( (UserTimeEntryFinderComponent) getComponent() ).getActivityDd();
    }
    ...
    public void setActivityDd(String activityDd) {
        ( (UserTimeEntryFinderComponent) getComponent() ).setActivityDd(activityDd);
    }
    ...
    public String getTask() {
        return ( (UserTimeEntryFinderComponent) getComponent() ).getTask();
    }
    ...
    public void setTask(String task) {
        ( (UserTimeEntryFinderComponent) getComponent() ).setTask(task);
    }
    ...
    public String getTaskDd() {
        return ( (UserTimeEntryFinderComponent) getComponent() ).getTaskDd();
    }
    ...
    public void setTaskDd(String taskDd) {
        ( (UserTimeEntryFinderComponent) getComponent() ).setTaskDd(taskDd);
    }
    ...
    public String getPeriodStart() {
        return ( (UserTimeEntryFinderComponent) getComponent() ).getPeriodStart();
    }
    ...
    public void setPeriodStart(String periodStart) {
        ( (UserTimeEntryFinderComponent) getComponent() ).setPeriodStart(periodStart);
    }
    ...
    public String getPeriodStartDd() {
        return ( (UserTimeEntryFinderComponent) getComponent() ).getPeriodStartDd();
    }
    ...
    public void setPeriodStartDd(String periodStartDd) {
        ( (UserTimeEntryFinderComponent) getComponent() ).setPeriodStartDd(periodStartDd);
    }
    ...
    public String getPeriodEnd() {
        return ( (UserTimeEntryFinderComponent) getComponent() ).getPeriodEnd();
    }
    ...
    public void setPeriodEnd(String periodEnd) {
        ( (UserTimeEntryFinderComponent) getComponent() ).setPeriodEnd(periodEnd);
    }
    ...
    public String getPeriodEndDd() {
        return ( (UserTimeEntryFinderComponent) getComponent() ).getPeriodEndDd();
    }
    ...
    public void setPeriodEndDd(String periodEndDd) {
        ( (UserTimeEntryFinderComponent) getComponent() ).setPeriodEndDd(periodEndDd);
    }
    ...
    public void populateRows(GridModel rows) {
        rows.clearRows();
        UserTimeEntryFinderOutDto outputDto = (UserTimeEntryFinderOutDto) ((UserTimeEntryFinderComponent) getComponent()).getFinderOutDto();
        if (outputDto != null) {
            GridModelRow row;
            for (int i = 0; i < outputDto.getRowsCount(); i++) {
                UserTimeEntryFinderOutRowDto rowDto = outputDto.getRows(i);
                row = rows.newRow();
