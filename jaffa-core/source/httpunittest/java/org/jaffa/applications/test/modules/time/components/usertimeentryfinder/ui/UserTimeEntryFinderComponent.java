...
// .//GEN-LAST:_imports
// .//GEN-BEGIN:_2_be
/** The controller for the UserTimeEntryFinder.
 */
public class UserTimeEntryFinderComponent extends FinderComponent2 {

    private static Logger log = Logger.getLogger(UserTimeEntryFinderComponent.class);
    ...
    private IUserTimeEntryFinder m_tx = null;
    ...
    public UserTimeEntryFinderComponent() {
        super();
    ...
    protected String getCriteriaFormName() {
        return "usertimeentry_userTimeEntryFinderCriteria";
    }
    ...
    protected String getResultsFormName() {
        return "usertimeentry_userTimeEntryFinderResults";
    }
    ...
    protected String getConsolidatedCriteriaAndResultsFormName() {
        return "usertimeentry_userTimeEntryFinderConsolidatedCriteriaAndResults";
    }
    ...
    protected String getExcelFormName() {
        return "usertimeentry_userTimeEntryFinderExcelResults";
    }
    ...
    protected String getXmlFormName() {
        return "usertimeentry_userTimeEntryFinderXmlResults";
    }
    ...
    protected FinderOutDto doInquiry() throws ApplicationExceptions, FrameworkException {
        ...
        UserTimeEntryFinderInDto inputDto = new UserTimeEntryFinderInDto();
        ...
        // perform the inquiry
        if (m_tx == null)
            m_tx = (IUserTimeEntryFinder) Factory.createObject(IUserTimeEntryFinder.class);
