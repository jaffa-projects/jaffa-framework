...
// .//GEN-LAST:imports
// .//GEN-BEGIN:2_be
/** This class has the meta information for the ActivityCode persistent class.
 */
public class ActivityCodeMeta {
    
    // domain-object class name
    private static String m_name = "org.jaffa.applications.test.modules.time.domain.ActivityCode";

    // token to be used for getting the label for the domain-object
    private static String m_labelToken = "[label.Jaffa.Time.ActivityCode]";
    ...
    public static final FieldMetaData META_DESCRIPTION = new StringFieldMetaData(DESCRIPTION, "[label.Jaffa.Admin.Time.ActivityCode.Description]", Boolean.TRUE, null, new Integer(50), FieldMetaData.MIXED_CASE);
