...
// .//GEN-LAST:_imports
// .//GEN-BEGIN:_2_be
/** The output for the UserTimeEntryLookup contains an array of instances of this class.
 */
public class UserTimeEntryLookupOutRowDto {
    ...
    public String toString() {
        ...
        buf.append("<UserTimeEntryLookupOutRowDto>");
        buf.append("<userName>"); if (userName != null) buf.append(StringHelper.convertToHTML(Formatter.format(userName))); buf.append("</userName>");
        buf.append("<projectCode>"); if (projectCode != null) buf.append(StringHelper.convertToHTML(Formatter.format(projectCode))); buf.append("</projectCode>");
        buf.append("<activity>"); if (activity != null) buf.append(StringHelper.convertToHTML(Formatter.format(activity))); buf.append("</activity>");
        buf.append("<task>"); if (task != null) buf.append(StringHelper.convertToHTML(Formatter.format(task))); buf.append("</task>");
        buf.append("<periodStart>"); if (periodStart != null) buf.append(StringHelper.convertToHTML(Formatter.format(periodStart))); buf.append("</periodStart>");
        buf.append("<periodEnd>"); if (periodEnd != null) buf.append(StringHelper.convertToHTML(Formatter.format(periodEnd))); buf.append("</periodEnd>");
        buf.append("</UserTimeEntryLookupOutRowDto>");
        return buf.toString();
    }
