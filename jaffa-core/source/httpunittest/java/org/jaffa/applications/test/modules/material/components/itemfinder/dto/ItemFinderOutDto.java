...
// .//GEN-LAST:_imports
// .//GEN-BEGIN:_2_be
/** The output for the ItemFinder.
 */
public class ItemFinderOutDto extends FinderOutDto {

    /** Holds an array of rows to be returned. */
    private List rows;

    /** Default Constructor.*/    
    public ItemFinderOutDto() {
        rows = new ArrayList();
    }
    ...
    public ItemFinderOutRowDto getRows(int index) {
        ...
        return (ItemFinderOutRowDto) rows.get(index);
    }
    ...
    public ItemFinderOutRowDto[] getRows() {
        return (ItemFinderOutRowDto[]) rows.toArray(new ItemFinderOutRowDto[0]);
    }
