...
// .//GEN-LAST:_imports
// .//GEN-BEGIN:_2_be
/** The Action class for handling events related to UserTimeEntryLookup.
 */
public class UserTimeEntryLookupAction extends LookupAction {
    private static final Logger log = Logger.getLogger(UserTimeEntryLookupAction.class);
    // .//GEN-END:_2_be
