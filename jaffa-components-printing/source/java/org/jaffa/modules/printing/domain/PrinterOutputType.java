...
// .//GEN-BEGIN:2_be
/**
 * Auto Generated Persistent class for the J_OUTPUT_TYPES table.
 * @author  Auto-Generated
 */
@XmlRootElement
@XmlAccessorType(XmlAccessType.FIELD)
@Entity
@Table(name="J_OUTPUT_TYPES")
@SqlResultSetMapping(name="PrinterOutputType",entities={@EntityResult(entityClass=PrinterOutputType.class)})
@TypeDefs({@TypeDef(name="dateTimeType", typeClass=DateTimeType.class), @TypeDef(name="dateOnlyType", typeClass=DateOnlyType.class)})
public class PrinterOutputType extends Persistent {

    private static final Logger log = Logger.getLogger(PrinterOutputType.class);
    ...
    @XmlElement(name="directPrinting")
    @Type(type="true_false")
    @Column(name="DIRECT_PRINTING")    
    private java.lang.Boolean m_directPrinting;
    ...
    /** Holds related OutputCommand objects. */
    private transient Collection m_outputCommandCollection;

    /** Holds related PrinterDefinition objects. */
    private transient Collection m_printerDefinitionCollection;
    ...
    public static boolean exists(UOW uow, java.lang.String outputType) throws FrameworkException {
        ...
        try {
            ...
            Criteria criteria = findByPKCriteria(outputType);
    ...
    public static PrinterOutputType findByPK(UOW uow, java.lang.String outputType) throws FrameworkException {
        ...
        try {
            ...
            Iterator itr = uow.query(criteria).iterator();
            if (itr.hasNext())
                return (PrinterOutputType) itr.next();
            else
                return null;
        } finally {
            if (localUow && uow != null)
    ...
    public static Criteria findByPKCriteria(java.lang.String outputType) {
        ...
        criteria.addCriteria(PrinterOutputTypeMeta.OUTPUT_TYPE, outputType);
        return criteria;
    }
    // .//GEN-END:2_be
    ...
    throws ValidationException, UpdatePrimaryKeyException, ReadOnlyObjectException, AlreadyLockedObjectException, FrameworkException {
        ...
        super.update();
        super.addInitialValue(PrinterOutputTypeMeta.OUTPUT_TYPE, m_outputType);
    ...
    throws ValidationException, FrameworkException {
        ...
        outputType = FieldValidator.validate(outputType, (StringFieldMetaData) PrinterOutputTypeMeta.META_OUTPUT_TYPE, true);

        // Invoke the Dynamic Rules Engine
        RulesEngine.doAllValidationsForDomainField(PrinterOutputTypeMeta.getName(), PrinterOutputTypeMeta.OUTPUT_TYPE, outputType, this.getUOW());
    ...
    throws ValidationException, ReadOnlyObjectException, AlreadyLockedObjectException, FrameworkException {
        ...
        super.update();
        super.addInitialValue(PrinterOutputTypeMeta.DESCRIPTION, m_description);
    ...
    throws ValidationException, FrameworkException {
        ...
        description = FieldValidator.validate(description, (StringFieldMetaData) PrinterOutputTypeMeta.META_DESCRIPTION, true);

        // Invoke the Dynamic Rules Engine
        RulesEngine.doAllValidationsForDomainField(PrinterOutputTypeMeta.getName(), PrinterOutputTypeMeta.DESCRIPTION, description, this.getUOW());
    ...
    /** Use this method to update the property directPrinting.
     * This method will do nothing and simply return if the input value is the same as the current value.
     * Validation will be performed on the input value.
     * This will try to lock the underlying database row, in case CAUTIOUS locking is specified at the time of query.
    ...
    throws ValidationException, ReadOnlyObjectException, AlreadyLockedObjectException, FrameworkException {
        // ignore, if the current value and new value are the same
        if (m_directPrinting == null ? directPrinting == null : m_directPrinting.equals(directPrinting))
            return;


        directPrinting = validateDirectPrinting(directPrinting);
        // .//GEN-END:directPrinting_be
        // Add custom code before setting the value//GEN-FIRST:directPrinting


        // .//GEN-LAST:directPrinting
        // .//GEN-BEGIN:directPrinting_1_be
        super.update();
        super.addInitialValue(PrinterOutputTypeMeta.DIRECT_PRINTING, m_directPrinting);
        m_directPrinting = directPrinting;
        // .//GEN-END:directPrinting_1_be
        // Add custom code after setting the value//GEN-FIRST:directPrinting_3


        // .//GEN-LAST:directPrinting_3
        // .//GEN-BEGIN:directPrinting_2_be
    }
    
    /** This method is present for backwards compatibility only.
     * It merely invokes the setDirectPrinting() method.
     * @param directPrinting New value of property directPrinting.
     * @throws ValidationException if an invalid value is passed.
     * @throws ReadOnlyObjectException if a Read-Only object is updated.
     * @throws AlreadyLockedObjectException if the underlying database row is already locked by another process.
     * @throws FrameworkException Indicates some system error
     */
    public void updateDirectPrinting(java.lang.Boolean directPrinting)
    throws ValidationException, ReadOnlyObjectException, AlreadyLockedObjectException, FrameworkException {
        setDirectPrinting(directPrinting);
    }

    /** Use this method to validate a value for the property directPrinting.
     * @param directPrinting Value to be validated for the property directPrinting.
     * @throws ValidationException if an invalid value is passed
     * @throws FrameworkException Indicates some system error
     */
    public java.lang.Boolean validateDirectPrinting(java.lang.Boolean directPrinting)
    throws ValidationException, FrameworkException {
        // .//GEN-END:directPrinting_2_be
        // Add custom code before validation//GEN-FIRST:directPrinting_1


        // .//GEN-LAST:directPrinting_1
        // .//GEN-BEGIN:directPrinting_3_be
        directPrinting = FieldValidator.validate(directPrinting, (BooleanFieldMetaData) PrinterOutputTypeMeta.META_DIRECT_PRINTING, true);

        // Invoke the Dynamic Rules Engine
        RulesEngine.doAllValidationsForDomainField(PrinterOutputTypeMeta.getName(), PrinterOutputTypeMeta.DIRECT_PRINTING, directPrinting, this.getUOW());

        // .//GEN-END:directPrinting_3_be
        // Add custom code after a successful validation//GEN-FIRST:directPrinting_2


        // .//GEN-LAST:directPrinting_2
        // .//GEN-BEGIN:directPrinting_4_be
        return directPrinting;
    }
    // .//GEN-END:directPrinting_4_be
    ...
    throws ValidationException, ReadOnlyObjectException, AlreadyLockedObjectException, FrameworkException {
        ...
        super.update();
        super.addInitialValue(PrinterOutputTypeMeta.CREATED_ON, m_createdOn);
    ...
    throws ValidationException, FrameworkException {
        ...
        createdOn = FieldValidator.validate(createdOn, (DateTimeFieldMetaData) PrinterOutputTypeMeta.META_CREATED_ON, true);

        // Invoke the Dynamic Rules Engine
        RulesEngine.doAllValidationsForDomainField(PrinterOutputTypeMeta.getName(), PrinterOutputTypeMeta.CREATED_ON, createdOn, this.getUOW());
    ...
    throws ValidationException, ReadOnlyObjectException, AlreadyLockedObjectException, FrameworkException {
        ...
        super.update();
        super.addInitialValue(PrinterOutputTypeMeta.CREATED_BY, m_createdBy);
    ...
    throws ValidationException, FrameworkException {
        ...
        createdBy = FieldValidator.validate(createdBy, (StringFieldMetaData) PrinterOutputTypeMeta.META_CREATED_BY, true);

        // Invoke the Dynamic Rules Engine
        RulesEngine.doAllValidationsForDomainField(PrinterOutputTypeMeta.getName(), PrinterOutputTypeMeta.CREATED_BY, createdBy, this.getUOW());
    ...
    throws ValidationException, ReadOnlyObjectException, AlreadyLockedObjectException, FrameworkException {
        ...
        super.update();
        super.addInitialValue(PrinterOutputTypeMeta.LAST_CHANGED_ON, m_lastChangedOn);
    ...
    throws ValidationException, FrameworkException {
        ...
        lastChangedOn = FieldValidator.validate(lastChangedOn, (DateTimeFieldMetaData) PrinterOutputTypeMeta.META_LAST_CHANGED_ON, true);

        // Invoke the Dynamic Rules Engine
        RulesEngine.doAllValidationsForDomainField(PrinterOutputTypeMeta.getName(), PrinterOutputTypeMeta.LAST_CHANGED_ON, lastChangedOn, this.getUOW());
    ...
    throws ValidationException, ReadOnlyObjectException, AlreadyLockedObjectException, FrameworkException {
        ...
        super.update();
        super.addInitialValue(PrinterOutputTypeMeta.LAST_CHANGED_BY, m_lastChangedBy);
    ...
    throws ValidationException, FrameworkException {
        ...
        lastChangedBy = FieldValidator.validate(lastChangedBy, (StringFieldMetaData) PrinterOutputTypeMeta.META_LAST_CHANGED_BY, true);

        // Invoke the Dynamic Rules Engine
        RulesEngine.doAllValidationsForDomainField(PrinterOutputTypeMeta.getName(), PrinterOutputTypeMeta.LAST_CHANGED_BY, lastChangedBy, this.getUOW());
    ...
    // .//GEN-BEGIN:outputCommandArray_1_be
    /** Returns an array of related OutputCommand objects.
     * @return an array of related OutputCommand objects.
     * @throws FrameworkException Indicates some system error
     */
    public OutputCommand[] getOutputCommandArray() throws FrameworkException {
        ...
        boolean localUow = false;
        try {
            OutputCommand[] output = null;
            if (m_outputCommandCollection == null && isDatabaseOccurence()) {
                Criteria criteria = findOutputCommandCriteria();
                if (uow == null || !uow.isActive()) {
                    uow = new UOW();
                    localUow = true;
                }
                Collection col = uow.query(criteria);
                m_outputCommandCollection = new ArrayList();
                for (Iterator itr = col.iterator(); itr.hasNext(); )
                    m_outputCommandCollection.add(itr.next());
            }

            if (m_outputCommandCollection != null)
                output = (OutputCommand[]) m_outputCommandCollection.toArray(new OutputCommand[0]);
            return output;
        } finally {
            if (localUow && uow != null)
                uow.rollback();
    ...
    /** Returns a Criteria object for retrieving the related OutputCommand objects.
     * @return a Criteria object for retrieving the related OutputCommand objects.
     */
    public Criteria findOutputCommandCriteria() {
        ...
        // .//GEN-END:outputCommandArray_1_be
        // Add custom criteria//GEN-FIRST:outputCommandArray_1
        criteria.addOrderBy(OutputCommandMeta.SEQUENCE_NO);      

        // .//GEN-LAST:outputCommandArray_1
        // .//GEN-BEGIN:outputCommandArray_2_be
        return criteria;
    }
     ...
     */
    public OutputCommand newOutputCommandObject()
    throws ValidationException, FrameworkException {
        m_outputCommandCollection = null;
        OutputCommand outputCommand = new OutputCommand();
        outputCommand.setOutputType(getOutputType());
        // .//GEN-END:outputCommandArray_2_be
        // Add custom code//GEN-FIRST:outputCommandArray_2


        // .//GEN-LAST:outputCommandArray_2
        // .//GEN-BEGIN:outputCommandArray_3_be
        return outputCommand;
    }
    // .//GEN-END:outputCommandArray_3_be
    // .//GEN-BEGIN:printerDefinitionArray_1_be
    /** Returns an array of related PrinterDefinition objects.
     * @return an array of related PrinterDefinition objects.
     * @throws FrameworkException Indicates some system error
     */
    public PrinterDefinition[] getPrinterDefinitionArray() throws FrameworkException {
        ...
        boolean localUow = false;
        try {
            PrinterDefinition[] output = null;
            if (m_printerDefinitionCollection == null && isDatabaseOccurence()) {
                Criteria criteria = findPrinterDefinitionCriteria();
                if (uow == null || !uow.isActive()) {
                    uow = new UOW();
                    localUow = true;
                }
                Collection col = uow.query(criteria);
                m_printerDefinitionCollection = new ArrayList();
                for (Iterator itr = col.iterator(); itr.hasNext(); )
                    m_printerDefinitionCollection.add(itr.next());
            }

            if (m_printerDefinitionCollection != null)
                output = (PrinterDefinition[]) m_printerDefinitionCollection.toArray(new PrinterDefinition[0]);
            return output;
        } finally {
            if (localUow && uow != null)
                uow.rollback();
    ...
    /** Returns a Criteria object for retrieving the related PrinterDefinition objects.
     * @return a Criteria object for retrieving the related PrinterDefinition objects.
     */
    public Criteria findPrinterDefinitionCriteria() {
        Criteria criteria = new Criteria();
        criteria.setTable(PrinterDefinitionMeta.getName());
        criteria.addCriteria(PrinterDefinitionMeta.OUTPUT_TYPE, getOutputType());
        // .//GEN-END:printerDefinitionArray_1_be
        // Add custom criteria//GEN-FIRST:printerDefinitionArray_1


        // .//GEN-LAST:printerDefinitionArray_1
        // .//GEN-BEGIN:printerDefinitionArray_2_be
        return criteria;
    }
     ...
     */
    public PrinterDefinition newPrinterDefinitionObject()
    throws ValidationException, FrameworkException {
        ...
        // .//GEN-END:printerDefinitionArray_2_be
        // Add custom code//GEN-FIRST:printerDefinitionArray_2


        // .//GEN-LAST:printerDefinitionArray_2
        // .//GEN-BEGIN:printerDefinitionArray_3_be
        return printerDefinition;
    }
    // .//GEN-END:printerDefinitionArray_3_be
    ...
    */
    public String toString() {
        ...
        buf.append("<directPrinting>"); if (m_directPrinting != null) buf.append(m_directPrinting); buf.append("</directPrinting>");
    ...
    public Object clone() throws CloneNotSupportedException {
        PrinterOutputType obj = (PrinterOutputType) super.clone();
        obj.m_outputCommandCollection = null;
        obj.m_printerDefinitionCollection = null;
        return obj;
    }
    // .//GEN-END:clone_1_be
    ...
    public void performPreDeleteReferentialIntegrity() throws PreDeleteFailedException {
        ...
        if (outputCommandArray != null && outputCommandArray.length > 0) {
            try {
                ...
                for (int i = 0; i < outputCommandArray.length; i++)
                    getUOW().delete(outputCommandArray[i]);
            } catch (Exception e) {
                throw new PreDeleteFailedException(null, e);
            }
        }
     ...
     * @link composition
     */
    /*#OutputCommand lnkOutputCommand;*/
     ...
     * @link association
     */
    /*#PrinterDefinition lnkPrinterDefinition;*/
    ...
    public void preUpdate() throws PreUpdateFailedException {
        try {
            if (getLastChangedOn() == null || !isModified(PrinterOutputTypeMeta.LAST_CHANGED_ON))
        ...
        try {
            if ((getLastChangedBy() == null || !isModified(PrinterOutputTypeMeta.LAST_CHANGED_BY)) && SecurityManager.getPrincipal() != null && SecurityManager.getPrincipal().getName() != null)
