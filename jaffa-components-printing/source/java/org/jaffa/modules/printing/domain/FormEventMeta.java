...
// .//GEN-LAST:imports
// .//GEN-BEGIN:2_be
/** This class has the meta information for the FormEvent persistent class.
 */
public class FormEventMeta {
    
    // domain-object class name
    private static String m_name = "org.jaffa.modules.printing.domain.FormEvent";

    // token to be used for getting the label for the domain-object
    private static String m_labelToken = "[label.Jaffa.Printing.FormEvent]";
    ...
    public static final FieldMetaData META_DESCRIPTION = new StringFieldMetaData(DESCRIPTION, "[label.Jaffa.Printing.FormEvent.Description]", Boolean.FALSE, null, new Integer(100), FieldMetaData.MIXED_CASE);
