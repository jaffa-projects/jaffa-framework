...
// .//GEN-LAST:_imports
// .//GEN-BEGIN:_2_be
/** The Action class for handling events related to FormEventFinder.
 */
public class FormEventFinderAction extends FinderAction {
    private static final Logger log = Logger.getLogger(FormEventFinderAction.class);
    ...
    public FormKey do_CreateFromCriteria_Clicked() {
        ...
        FormEventFinderForm myForm = (FormEventFinderForm) form;
        FormEventFinderComponent myComp = (FormEventFinderComponent) myForm.getComponent();
