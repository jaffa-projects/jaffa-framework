 ...
 */
public class FormDefinitionMaintenanceAction extends MaintAction {

    private static final Logger log = Logger.getLogger(FormDefinitionMaintenanceAction.class);
    // .//GEN-END:_2_be
