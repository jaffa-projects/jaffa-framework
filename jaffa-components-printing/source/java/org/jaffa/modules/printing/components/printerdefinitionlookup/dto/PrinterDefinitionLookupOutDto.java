...
// .//GEN-LAST:_imports
// .//GEN-BEGIN:_2_be
/** The output for the PrinterDefinitionLookup.
 */
public class PrinterDefinitionLookupOutDto extends FinderOutDto {

    /** Holds an array of rows to be returned. */
    private List rows;

    /** Default Constructor.*/    
    public PrinterDefinitionLookupOutDto() {
        rows = new ArrayList();
    }
    ...
    public PrinterDefinitionLookupOutRowDto getRows(int index) {
        ...
        return (PrinterDefinitionLookupOutRowDto) rows.get(index);
    }
    ...
    public PrinterDefinitionLookupOutRowDto[] getRows() {
        return (PrinterDefinitionLookupOutRowDto[]) rows.toArray(new PrinterDefinitionLookupOutRowDto[0]);
    }
