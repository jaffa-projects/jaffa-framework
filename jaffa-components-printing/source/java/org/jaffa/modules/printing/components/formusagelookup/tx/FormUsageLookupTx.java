 ...
 ******************************************************/
package org.jaffa.modules.printing.components.formusagelookup.tx;
...
// .//GEN-LAST:_imports
// .//GEN-BEGIN:_2_be
/** Lookup for FormUsage objects.
*/
public class FormUsageLookupTx implements IFormUsageLookup {

    private static Logger log = Logger.getLogger(FormUsageLookupTx.class);
     ...
     */
    public FormUsageLookupOutDto find(FormUsageLookupInDto input)
    throws FrameworkException, ApplicationExceptions {
        ...
        try {
            ...
            FormUsageLookupOutDto output = buildDto(uow, results, input);
    ...
    private FormUsageLookupOutDto buildDto(UOW uow, Collection results, FormUsageLookupInDto input)
    throws UOWException {
