 ...
 */
public class OutputCommandViewerAction extends ActionBase {

    private static final Logger log = Logger.getLogger(OutputCommandViewerAction.class);
    ...
    public FormKey do_Close_Clicked() {
        ...
        return ((OutputCommandViewerForm) form).getComponent().quitAndReturnToCallingScreen();
    }
    ...
    public FormKey do_Update_Clicked() {
        ...
        OutputCommandViewerForm myForm = (OutputCommandViewerForm) form;
        OutputCommandViewerComponent myComp = (OutputCommandViewerComponent) myForm.getComponent();
        try {
