...
// .//GEN-LAST:_imports
// .//GEN-BEGIN:_2_be
/** The FormBean class to support FormEventFinder.
 */
public class FormEventFinderForm extends FinderForm {

    private static Logger log = Logger.getLogger(FormEventFinderForm.class);
    // .//GEN-END:_2_be
    ...
    public String getEventName() {
        return ( (FormEventFinderComponent) getComponent() ).getEventName();
    }
    ...
    public void setEventName(String eventName) {
        ( (FormEventFinderComponent) getComponent() ).setEventName(eventName);
    }
    ...
    public String getEventNameDd() {
        return ( (FormEventFinderComponent) getComponent() ).getEventNameDd();
    }
    ...
    public void setEventNameDd(String eventNameDd) {
        ( (FormEventFinderComponent) getComponent() ).setEventNameDd(eventNameDd);
    }
    ...
    public String getDescription() {
        return ( (FormEventFinderComponent) getComponent() ).getDescription();
    }
    ...
    public void setDescription(String description) {
        ( (FormEventFinderComponent) getComponent() ).setDescription(description);
    }
    ...
    public String getDescriptionDd() {
        return ( (FormEventFinderComponent) getComponent() ).getDescriptionDd();
    }
    ...
    public void setDescriptionDd(String descriptionDd) {
        ( (FormEventFinderComponent) getComponent() ).setDescriptionDd(descriptionDd);
    }
    ...
    public void populateRows(GridModel rows) {
        rows.clearRows();
        FormEventFinderOutDto outputDto = (FormEventFinderOutDto) ((FormEventFinderComponent) getComponent()).getFinderOutDto();
        if (outputDto != null) {
            GridModelRow row;
            for (int i = 0; i < outputDto.getRowsCount(); i++) {
                FormEventFinderOutRowDto rowDto = outputDto.getRows(i);
                row = rows.newRow();
