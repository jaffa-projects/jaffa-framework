 ...
 ******************************************************/
package org.jaffa.modules.printing.components.printerdefinitionlookup.tx;
...
import org.jaffa.modules.printing.components.printerdefinitionlookup.IPrinterDefinitionLookup;
...
// .//GEN-LAST:_imports
// .//GEN-BEGIN:_2_be
/** Lookup for PrinterDefinition objects.
*/
public class PrinterDefinitionLookupTx implements IPrinterDefinitionLookup {

    private static Logger log = Logger.getLogger(PrinterDefinitionLookupTx.class);
     ...
     */
    public PrinterDefinitionLookupOutDto find(PrinterDefinitionLookupInDto input)
    throws FrameworkException, ApplicationExceptions {
        ...
        try {
            ...
            PrinterDefinitionLookupOutDto output = buildDto(uow, results, input);
    ...
    private PrinterDefinitionLookupOutDto buildDto(UOW uow, Collection results, PrinterDefinitionLookupInDto input)
    throws UOWException {
