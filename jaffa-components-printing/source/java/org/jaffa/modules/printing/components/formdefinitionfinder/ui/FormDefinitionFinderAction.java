...
// .//GEN-LAST:_imports
// .//GEN-BEGIN:_2_be
/** The Action class for handling events related to FormDefinitionFinder.
 */
public class FormDefinitionFinderAction extends FinderAction {
    private static final Logger log = Logger.getLogger(FormDefinitionFinderAction.class);
