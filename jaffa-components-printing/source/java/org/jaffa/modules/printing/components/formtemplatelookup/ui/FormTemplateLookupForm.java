 ...
 ******************************************************/
package org.jaffa.modules.printing.components.formtemplatelookup.ui;
...
import org.jaffa.modules.printing.components.formtemplatelookup.dto.FormTemplateLookupOutDto;
import org.jaffa.modules.printing.components.formtemplatelookup.dto.FormTemplateLookupOutRowDto;
...
// .//GEN-LAST:_imports
// .//GEN-BEGIN:_2_be
/** The FormBean class to support FormTemplateLookup.
 */
public class FormTemplateLookupForm extends LookupForm {

    private static Logger log = Logger.getLogger(FormTemplateLookupForm.class);
    // .//GEN-END:_2_be
    ...
    public String getFormId() {
        return ( (FormTemplateLookupComponent) getComponent() ).getFormId();
    }
    ...
    public void setFormId(String formId) {
        ( (FormTemplateLookupComponent) getComponent() ).setFormId(formId);
    }
    ...
    public String getFormIdDd() {
        return ( (FormTemplateLookupComponent) getComponent() ).getFormIdDd();
    }
    ...
    public void setFormIdDd(String formIdDd) {
        ( (FormTemplateLookupComponent) getComponent() ).setFormIdDd(formIdDd);
    }
    ...
    public String getTemplateData() {
        return ( (FormTemplateLookupComponent) getComponent() ).getTemplateData();
    }
    ...
    public void setTemplateData(String templateData) {
        ( (FormTemplateLookupComponent) getComponent() ).setTemplateData(templateData);
    }
    ...
    public String getTemplateDataDd() {
        return ( (FormTemplateLookupComponent) getComponent() ).getTemplateDataDd();
    }
    ...
    public void setTemplateDataDd(String templateDataDd) {
        ( (FormTemplateLookupComponent) getComponent() ).setTemplateDataDd(templateDataDd);
    }
    ...
    public String getLayoutData() {
        return ( (FormTemplateLookupComponent) getComponent() ).getLayoutData();
    }
    ...
    public void setLayoutData(String layoutData) {
        ( (FormTemplateLookupComponent) getComponent() ).setLayoutData(layoutData);
    }
    ...
    public String getLayoutDataDd() {
        return ( (FormTemplateLookupComponent) getComponent() ).getLayoutDataDd();
    }
    ...
    public void setLayoutDataDd(String layoutDataDd) {
        ( (FormTemplateLookupComponent) getComponent() ).setLayoutDataDd(layoutDataDd);
    }
