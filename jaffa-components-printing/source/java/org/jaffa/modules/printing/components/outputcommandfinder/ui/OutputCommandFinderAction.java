...
// .//GEN-LAST:_imports
// .//GEN-BEGIN:_2_be
/** The Action class for handling events related to OutputCommandFinder.
 */
public class OutputCommandFinderAction extends FinderAction {
    private static final Logger log = Logger.getLogger(OutputCommandFinderAction.class);
