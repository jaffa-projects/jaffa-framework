...
import org.jaffa.modules.printing.components.formtemplatelookup.IFormTemplateLookup;
import org.jaffa.modules.printing.components.formtemplatelookup.dto.FormTemplateLookupInDto;
...
// .//GEN-LAST:_imports
// .//GEN-BEGIN:_2_be
/** The controller for the FormTemplateLookup.
 */
public class FormTemplateLookupComponent extends LookupComponent2 {

    private static Logger log = Logger.getLogger(FormTemplateLookupComponent.class);
    ...
    private IFormTemplateLookup m_tx = null;
    ...
    public FormTemplateLookupComponent() {
        super();
    ...
    protected String getCriteriaFormName() {
        return "jaffa_printing_formTemplateLookupCriteria";
    }
    ...
    protected String getResultsFormName() {
        return "jaffa_printing_formTemplateLookupResults";
    }
    ...
    protected String getConsolidatedCriteriaAndResultsFormName() {
        return "jaffa_printing_formTemplateLookupConsolidatedCriteriaAndResults";
    }
    // .//GEN-END:_2_be
    ...
    protected FinderOutDto doInquiry() throws ApplicationExceptions, FrameworkException {
        ...
        FormTemplateLookupInDto inputDto = new FormTemplateLookupInDto();
        ...
        // perform the inquiry
        if (m_tx == null)
            m_tx = (IFormTemplateLookup) Factory.createObject(IFormTemplateLookup.class);
