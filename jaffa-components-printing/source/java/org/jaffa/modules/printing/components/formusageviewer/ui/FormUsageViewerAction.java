 ...
 */
public class FormUsageViewerAction extends ActionBase {

    private static final Logger log = Logger.getLogger(FormUsageViewerAction.class);
    ...
    public FormKey do_Close_Clicked() {
        ...
        return ((FormUsageViewerForm) form).getComponent().quitAndReturnToCallingScreen();
    }
    ...
    public FormKey do_Update_Clicked() {
        ...
        FormUsageViewerForm myForm = (FormUsageViewerForm) form;
        FormUsageViewerComponent myComp = (FormUsageViewerComponent) myForm.getComponent();
        try {
