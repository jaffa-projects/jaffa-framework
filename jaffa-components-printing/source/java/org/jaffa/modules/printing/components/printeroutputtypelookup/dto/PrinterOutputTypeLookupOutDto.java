...
// .//GEN-LAST:_imports
// .//GEN-BEGIN:_2_be
/** The output for the PrinterOutputTypeLookup.
 */
public class PrinterOutputTypeLookupOutDto extends FinderOutDto {

    /** Holds an array of rows to be returned. */
    private List rows;

    /** Default Constructor.*/    
    public PrinterOutputTypeLookupOutDto() {
        rows = new ArrayList();
    }
    ...
    public PrinterOutputTypeLookupOutRowDto getRows(int index) {
        ...
        return (PrinterOutputTypeLookupOutRowDto) rows.get(index);
    }
    ...
    public PrinterOutputTypeLookupOutRowDto[] getRows() {
        return (PrinterOutputTypeLookupOutRowDto[]) rows.toArray(new PrinterOutputTypeLookupOutRowDto[0]);
    }
