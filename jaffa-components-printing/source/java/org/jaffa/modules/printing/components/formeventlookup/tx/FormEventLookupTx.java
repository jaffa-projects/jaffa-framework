 ...
 ******************************************************/
package org.jaffa.modules.printing.components.formeventlookup.tx;
...
// .//GEN-LAST:_imports
// .//GEN-BEGIN:_2_be
/** Lookup for FormEvent objects.
*/
public class FormEventLookupTx implements IFormEventLookup {

    private static Logger log = Logger.getLogger(FormEventLookupTx.class);
     ...
     */
    public FormEventLookupOutDto find(FormEventLookupInDto input)
    ...
    private FormEventLookupOutDto buildDto(UOW uow, Collection results, FormEventLookupInDto input)
    throws UOWException {
