 ...
 ******************************************************/
package org.jaffa.modules.printing.components.outputcommandlookup.dto;
...
// .//GEN-LAST:_imports
// .//GEN-BEGIN:_2_be
/** The output for the OutputCommandLookup contains an array of instances of this class.
 */
public class OutputCommandLookupOutRowDto {
    ...
    public String toString() {
        ...
        buf.append("<OutputCommandLookupOutRowDto>");
        buf.append("<outputCommandId>"); if (outputCommandId != null) buf.append(StringHelper.convertToHTML(Formatter.format(outputCommandId))); buf.append("</outputCommandId>");
        ...
        buf.append("<sequenceNo>"); if (sequenceNo != null) buf.append(StringHelper.convertToHTML(Formatter.format(sequenceNo))); buf.append("</sequenceNo>");
        buf.append("<osPattern>"); if (osPattern != null) buf.append(StringHelper.convertToHTML(Formatter.format(osPattern))); buf.append("</osPattern>");
        buf.append("<commandLine>"); if (commandLine != null) buf.append(StringHelper.convertToHTML(Formatter.format(commandLine))); buf.append("</commandLine>");
