...
// .//GEN-LAST:_imports
// .//GEN-BEGIN:_2_be
/** The Action class for handling events related to PrinterOutputTypeLookup.
 */
public class PrinterOutputTypeLookupAction extends LookupAction {
    private static final Logger log = Logger.getLogger(PrinterOutputTypeLookupAction.class);
    // .//GEN-END:_2_be
    ...
    public FormKey do_CreateFromCriteria_Clicked() {
        ...
        PrinterOutputTypeLookupForm myForm = (PrinterOutputTypeLookupForm) form;
        PrinterOutputTypeLookupComponent myComp = (PrinterOutputTypeLookupComponent) myForm.getComponent();
