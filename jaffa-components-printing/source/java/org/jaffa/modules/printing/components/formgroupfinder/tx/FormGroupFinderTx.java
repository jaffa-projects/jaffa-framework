 ...
 ******************************************************/
package org.jaffa.modules.printing.components.formgroupfinder.tx;
...
// .//GEN-LAST:_imports
// .//GEN-BEGIN:_2_be
/** Finder for FormGroup objects.
*/
public class FormGroupFinderTx implements IFormGroupFinder {

    private static Logger log = Logger.getLogger(FormGroupFinderTx.class);
     ...
     */
    public FormGroupFinderOutDto find(FormGroupFinderInDto input)
    ...
    private FormGroupFinderOutDto buildDto(UOW uow, Collection results, FormGroupFinderInDto input)
    throws UOWException {
