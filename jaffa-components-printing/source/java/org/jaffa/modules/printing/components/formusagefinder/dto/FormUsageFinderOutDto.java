...
// .//GEN-LAST:_imports
// .//GEN-BEGIN:_2_be
/** The output for the FormUsageFinder.
 */
public class FormUsageFinderOutDto extends FinderOutDto {

    /** Holds an array of rows to be returned. */
    private List rows;

    /** Default Constructor.*/    
    public FormUsageFinderOutDto() {
        rows = new ArrayList();
    }
    ...
    public FormUsageFinderOutRowDto getRows(int index) {
        ...
        return (FormUsageFinderOutRowDto) rows.get(index);
    }
    ...
    public FormUsageFinderOutRowDto[] getRows() {
        return (FormUsageFinderOutRowDto[]) rows.toArray(new FormUsageFinderOutRowDto[0]);
    }
