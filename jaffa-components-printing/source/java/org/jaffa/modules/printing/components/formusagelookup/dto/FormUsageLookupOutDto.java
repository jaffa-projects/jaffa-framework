...
// .//GEN-LAST:_imports
// .//GEN-BEGIN:_2_be
/** The output for the FormUsageLookup.
 */
public class FormUsageLookupOutDto extends FinderOutDto {

    /** Holds an array of rows to be returned. */
    private List rows;

    /** Default Constructor.*/    
    public FormUsageLookupOutDto() {
        rows = new ArrayList();
    }
    ...
    public FormUsageLookupOutRowDto getRows(int index) {
        ...
        return (FormUsageLookupOutRowDto) rows.get(index);
    }
    ...
    public FormUsageLookupOutRowDto[] getRows() {
        return (FormUsageLookupOutRowDto[]) rows.toArray(new FormUsageLookupOutRowDto[0]);
    }
