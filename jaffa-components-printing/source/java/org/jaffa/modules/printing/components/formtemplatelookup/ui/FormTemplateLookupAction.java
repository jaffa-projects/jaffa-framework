...
// .//GEN-LAST:_imports
// .//GEN-BEGIN:_2_be
/** The Action class for handling events related to FormTemplateLookup.
 */
public class FormTemplateLookupAction extends LookupAction {
    private static final Logger log = Logger.getLogger(FormTemplateLookupAction.class);
    // .//GEN-END:_2_be
