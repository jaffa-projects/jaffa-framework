...
// .//GEN-LAST:_imports
// .//GEN-BEGIN:_2_be
/** The output for the FormGroupFinder.
 */
public class FormGroupFinderOutDto extends FinderOutDto {

    /** Holds an array of rows to be returned. */
    private List rows;

    /** Default Constructor.*/    
    public FormGroupFinderOutDto() {
        rows = new ArrayList();
    }
    ...
    public FormGroupFinderOutRowDto getRows(int index) {
        ...
        return (FormGroupFinderOutRowDto) rows.get(index);
    }
    ...
    public FormGroupFinderOutRowDto[] getRows() {
        return (FormGroupFinderOutRowDto[]) rows.toArray(new FormGroupFinderOutRowDto[0]);
    }
