...
// .//GEN-LAST:_imports
// .//GEN-BEGIN:_2_be
/** The output for the FormGroupLookup.
 */
public class FormGroupLookupOutDto extends FinderOutDto {

    /** Holds an array of rows to be returned. */
    private List rows;

    /** Default Constructor.*/    
    public FormGroupLookupOutDto() {
        rows = new ArrayList();
    }
    ...
    public FormGroupLookupOutRowDto getRows(int index) {
        ...
        return (FormGroupLookupOutRowDto) rows.get(index);
    }
    ...
    public FormGroupLookupOutRowDto[] getRows() {
        return (FormGroupLookupOutRowDto[]) rows.toArray(new FormGroupLookupOutRowDto[0]);
    }
