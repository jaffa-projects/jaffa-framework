 ...
 */
public class PrinterDefinitionViewerAction extends ActionBase {

    private static final Logger log = Logger.getLogger(PrinterDefinitionViewerAction.class);
    ...
    public FormKey do_Close_Clicked() {
        ...
        return ((PrinterDefinitionViewerForm) form).getComponent().quitAndReturnToCallingScreen();
    }
    ...
    public FormKey do_Update_Clicked() {
        ...
        PrinterDefinitionViewerForm myForm = (PrinterDefinitionViewerForm) form;
        PrinterDefinitionViewerComponent myComp = (PrinterDefinitionViewerComponent) myForm.getComponent();
        try {
