...
// .//GEN-LAST:_imports
// .//GEN-BEGIN:_2_be
/** The Action class for handling events related to FormEventLookup.
 */
public class FormEventLookupAction extends LookupAction {
    private static final Logger log = Logger.getLogger(FormEventLookupAction.class);
    // .//GEN-END:_2_be
