...
// .//GEN-LAST:_imports
// .//GEN-BEGIN:_2_be
/** The Action class for handling events related to FormGroupFinder.
 */
public class FormGroupFinderAction extends FinderAction {
    private static final Logger log = Logger.getLogger(FormGroupFinderAction.class);
