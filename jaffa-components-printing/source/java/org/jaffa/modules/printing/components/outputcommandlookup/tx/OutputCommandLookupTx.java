 ...
 ******************************************************/
package org.jaffa.modules.printing.components.outputcommandlookup.tx;
...
// .//GEN-LAST:_imports
// .//GEN-BEGIN:_2_be
/** Lookup for OutputCommand objects.
*/
public class OutputCommandLookupTx implements IOutputCommandLookup {

    private static Logger log = Logger.getLogger(OutputCommandLookupTx.class);
     ...
     */
    public OutputCommandLookupOutDto find(OutputCommandLookupInDto input)
    throws FrameworkException, ApplicationExceptions {
        ...
        try {
            ...
            OutputCommandLookupOutDto output = buildDto(uow, results, input);
    ...
    private OutputCommandLookupOutDto buildDto(UOW uow, Collection results, OutputCommandLookupInDto input)
    throws UOWException {
