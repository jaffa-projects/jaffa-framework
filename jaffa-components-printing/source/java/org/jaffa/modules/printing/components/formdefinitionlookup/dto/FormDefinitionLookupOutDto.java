...
// .//GEN-LAST:_imports
// .//GEN-BEGIN:_2_be
/** The output for the FormDefinitionLookup.
 */
public class FormDefinitionLookupOutDto extends FinderOutDto {

    /** Holds an array of rows to be returned. */
    private List rows;

    /** Default Constructor.*/    
    public FormDefinitionLookupOutDto() {
        rows = new ArrayList();
    }
    ...
    public FormDefinitionLookupOutRowDto getRows(int index) {
        ...
        return (FormDefinitionLookupOutRowDto) rows.get(index);
    }
    ...
    public FormDefinitionLookupOutRowDto[] getRows() {
        return (FormDefinitionLookupOutRowDto[]) rows.toArray(new FormDefinitionLookupOutRowDto[0]);
    }
