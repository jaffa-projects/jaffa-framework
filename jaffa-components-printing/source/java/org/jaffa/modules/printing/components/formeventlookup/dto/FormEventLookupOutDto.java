...
// .//GEN-LAST:_imports
// .//GEN-BEGIN:_2_be
/** The output for the FormEventLookup.
 */
public class FormEventLookupOutDto extends FinderOutDto {

    /** Holds an array of rows to be returned. */
    private List rows;

    /** Default Constructor.*/    
    public FormEventLookupOutDto() {
        rows = new ArrayList();
    }
    ...
    public FormEventLookupOutRowDto getRows(int index) {
        ...
        return (FormEventLookupOutRowDto) rows.get(index);
    }
    ...
    public FormEventLookupOutRowDto[] getRows() {
        return (FormEventLookupOutRowDto[]) rows.toArray(new FormEventLookupOutRowDto[0]);
    }
