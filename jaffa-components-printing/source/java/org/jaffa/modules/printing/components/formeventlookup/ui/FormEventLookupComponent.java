...
import org.jaffa.modules.printing.components.formeventlookup.IFormEventLookup;
...
// .//GEN-LAST:_imports
// .//GEN-BEGIN:_2_be
/** The controller for the FormEventLookup.
 */
public class FormEventLookupComponent extends LookupComponent2 {

    private static Logger log = Logger.getLogger(FormEventLookupComponent.class);
    ...
    private IFormEventLookup m_tx = null;
    ...
    public FormEventLookupComponent() {
        super();
    ...
    protected String getCriteriaFormName() {
        return "jaffa_printing_formEventLookupCriteria";
    }
    ...
    protected String getResultsFormName() {
        return "jaffa_printing_formEventLookupResults";
    }
    ...
    protected String getConsolidatedCriteriaAndResultsFormName() {
        return "jaffa_printing_formEventLookupConsolidatedCriteriaAndResults";
    }
    // .//GEN-END:_2_be
    ...
    protected FinderOutDto doInquiry() throws ApplicationExceptions, FrameworkException {
        ...
        FormEventLookupInDto inputDto = new FormEventLookupInDto();
        ...
        // perform the inquiry
        if (m_tx == null)
            m_tx = (IFormEventLookup) Factory.createObject(IFormEventLookup.class);
