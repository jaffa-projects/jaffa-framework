...
// .//GEN-LAST:_imports
// .//GEN-BEGIN:_2_be
/** The Action class for handling events related to FormDefinitionLookup.
 */
public class FormDefinitionLookupAction extends LookupAction {
    private static final Logger log = Logger.getLogger(FormDefinitionLookupAction.class);
    // .//GEN-END:_2_be
