...
import org.jaffa.modules.printing.components.formusagelookup.IFormUsageLookup;
import org.jaffa.modules.printing.components.formusagelookup.dto.FormUsageLookupInDto;
...
// .//GEN-LAST:_imports
// .//GEN-BEGIN:_2_be
/** The controller for the FormUsageLookup.
 */
public class FormUsageLookupComponent extends LookupComponent2 {

    private static Logger log = Logger.getLogger(FormUsageLookupComponent.class);
    ...
    private IFormUsageLookup m_tx = null;
    ...
    public FormUsageLookupComponent() {
        super();
    ...
    protected String getCriteriaFormName() {
        return "jaffa_printing_formUsageLookupCriteria";
    }
    ...
    protected String getResultsFormName() {
        return "jaffa_printing_formUsageLookupResults";
    }
    ...
    protected String getConsolidatedCriteriaAndResultsFormName() {
        return "jaffa_printing_formUsageLookupConsolidatedCriteriaAndResults";
    }
    // .//GEN-END:_2_be
    ...
    protected FinderOutDto doInquiry() throws ApplicationExceptions, FrameworkException {
        ...
        FormUsageLookupInDto inputDto = new FormUsageLookupInDto();
        ...
        // perform the inquiry
        if (m_tx == null)
            m_tx = (IFormUsageLookup) Factory.createObject(IFormUsageLookup.class);
