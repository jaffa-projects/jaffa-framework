...
// .//GEN-LAST:_imports
// .//GEN-BEGIN:_2_be
/** The Action class for handling events related to FormTemplateFinder.
 */
public class FormTemplateFinderAction extends FinderAction {
    private static final Logger log = Logger.getLogger(FormTemplateFinderAction.class);
