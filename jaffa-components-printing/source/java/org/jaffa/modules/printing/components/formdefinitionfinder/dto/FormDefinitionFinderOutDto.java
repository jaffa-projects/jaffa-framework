...
// .//GEN-LAST:_imports
// .//GEN-BEGIN:_2_be
/** The output for the FormDefinitionFinder.
 */
public class FormDefinitionFinderOutDto extends FinderOutDto {

    /** Holds an array of rows to be returned. */
    private List rows;

    /** Default Constructor.*/    
    public FormDefinitionFinderOutDto() {
        rows = new ArrayList();
    }
    ...
    public FormDefinitionFinderOutRowDto getRows(int index) {
        ...
        return (FormDefinitionFinderOutRowDto) rows.get(index);
    }
    ...
    public FormDefinitionFinderOutRowDto[] getRows() {
        return (FormDefinitionFinderOutRowDto[]) rows.toArray(new FormDefinitionFinderOutRowDto[0]);
    }
