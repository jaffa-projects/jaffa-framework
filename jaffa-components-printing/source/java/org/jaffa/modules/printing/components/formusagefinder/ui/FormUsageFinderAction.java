...
// .//GEN-LAST:_imports
// .//GEN-BEGIN:_2_be
/** The Action class for handling events related to FormUsageFinder.
 */
public class FormUsageFinderAction extends FinderAction {
    private static final Logger log = Logger.getLogger(FormUsageFinderAction.class);
