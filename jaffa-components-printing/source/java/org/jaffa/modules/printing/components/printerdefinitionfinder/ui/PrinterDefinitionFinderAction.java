...
// .//GEN-LAST:_imports
// .//GEN-BEGIN:_2_be
/** The Action class for handling events related to PrinterDefinitionFinder.
 */
public class PrinterDefinitionFinderAction extends FinderAction {
    private static final Logger log = Logger.getLogger(PrinterDefinitionFinderAction.class);
    ...
    public FormKey do_CreateFromCriteria_Clicked() {
        ...
        PrinterDefinitionFinderForm myForm = (PrinterDefinitionFinderForm) form;
        PrinterDefinitionFinderComponent myComp = (PrinterDefinitionFinderComponent) myForm.getComponent();
