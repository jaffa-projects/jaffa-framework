 ...
 ******************************************************/
package org.jaffa.modules.printing.components.formtemplatelookup.tx;
...
// .//GEN-LAST:_imports
// .//GEN-BEGIN:_2_be
/** Lookup for FormTemplate objects.
*/
public class FormTemplateLookupTx implements IFormTemplateLookup {

    private static Logger log = Logger.getLogger(FormTemplateLookupTx.class);
     ...
     */
    public FormTemplateLookupOutDto find(FormTemplateLookupInDto input)
    throws FrameworkException, ApplicationExceptions {
        ...
        try {
            ...
            FormTemplateLookupOutDto output = buildDto(uow, results, input);
    ...
    private FormTemplateLookupOutDto buildDto(UOW uow, Collection results, FormTemplateLookupInDto input)
    throws UOWException {
