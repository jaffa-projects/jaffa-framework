 ...
 */
public class FormGroupViewerAction extends ActionBase {

    private static final Logger log = Logger.getLogger(FormGroupViewerAction.class);
    ...
    public FormKey do_Close_Clicked() {
        ...
        return ((FormGroupViewerForm) form).getComponent().quitAndReturnToCallingScreen();
    }
    ...
    public FormKey do_Update_Clicked() {
        ...
        FormGroupViewerForm myForm = (FormGroupViewerForm) form;
        FormGroupViewerComponent myComp = (FormGroupViewerComponent) myForm.getComponent();
        try {
