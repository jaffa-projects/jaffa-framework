...
// .//GEN-LAST:_imports
// .//GEN-BEGIN:_2_be
/** The controller for the PrinterDefinitionLookup.
 */
public class PrinterDefinitionLookupComponent extends LookupComponent2 {

    private static Logger log = Logger.getLogger(PrinterDefinitionLookupComponent.class);
    ...
    private IPrinterDefinitionLookup m_tx = null;
    ...
    protected String getCriteriaFormName() {
        return "jaffa_printing_printerDefinitionLookupCriteria";
    }
    ...
    protected String getResultsFormName() {
        return "jaffa_printing_printerDefinitionLookupResults";
    }
    ...
    protected String getConsolidatedCriteriaAndResultsFormName() {
        return "jaffa_printing_printerDefinitionLookupConsolidatedCriteriaAndResults";
    }
    // .//GEN-END:_2_be
    ...
    protected FinderOutDto doInquiry() throws ApplicationExceptions, FrameworkException {
        ...
        // perform the inquiry
        if (m_tx == null)
            m_tx = (IPrinterDefinitionLookup) Factory.createObject(IPrinterDefinitionLookup.class);
