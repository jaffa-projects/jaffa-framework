...
// .//GEN-LAST:_imports
// .//GEN-BEGIN:_2_be
/** The output for the OutputCommandLookup.
 */
public class OutputCommandLookupOutDto extends FinderOutDto {

    /** Holds an array of rows to be returned. */
    private List rows;

    /** Default Constructor.*/    
    public OutputCommandLookupOutDto() {
        rows = new ArrayList();
    }
    ...
    public OutputCommandLookupOutRowDto getRows(int index) {
        ...
        return (OutputCommandLookupOutRowDto) rows.get(index);
    }
    ...
    public OutputCommandLookupOutRowDto[] getRows() {
        return (OutputCommandLookupOutRowDto[]) rows.toArray(new OutputCommandLookupOutRowDto[0]);
    }
