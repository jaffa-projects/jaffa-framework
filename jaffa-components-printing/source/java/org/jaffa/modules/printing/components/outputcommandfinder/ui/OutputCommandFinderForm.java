 ...
 ******************************************************/
package org.jaffa.modules.printing.components.outputcommandfinder.ui;
...
// .//GEN-LAST:_imports
// .//GEN-BEGIN:_2_be
/** The FormBean class to support OutputCommandFinder.
 */
public class OutputCommandFinderForm extends FinderForm {

    private static Logger log = Logger.getLogger(OutputCommandFinderForm.class);
    // .//GEN-END:_2_be
    ...
    public String getOutputCommandId() {
        return ( (OutputCommandFinderComponent) getComponent() ).getOutputCommandId();
    }
    ...
    public void setOutputCommandId(String outputCommandId) {
        ( (OutputCommandFinderComponent) getComponent() ).setOutputCommandId(outputCommandId);
    }
    ...
    public String getOutputCommandIdDd() {
        return ( (OutputCommandFinderComponent) getComponent() ).getOutputCommandIdDd();
    }
    ...
    public void setOutputCommandIdDd(String outputCommandIdDd) {
        ( (OutputCommandFinderComponent) getComponent() ).setOutputCommandIdDd(outputCommandIdDd);
    }
    ...
    public String getOutputType() {
        return ( (OutputCommandFinderComponent) getComponent() ).getOutputType();
    }
    ...
    public void setOutputType(String outputType) {
        ( (OutputCommandFinderComponent) getComponent() ).setOutputType(outputType);
    }
    ...
    public String getOutputTypeDd() {
        return ( (OutputCommandFinderComponent) getComponent() ).getOutputTypeDd();
    }
    ...
    public void setOutputTypeDd(String outputTypeDd) {
        ( (OutputCommandFinderComponent) getComponent() ).setOutputTypeDd(outputTypeDd);
    }
    ...
    public String getSequenceNo() {
        return ( (OutputCommandFinderComponent) getComponent() ).getSequenceNo();
    }
    ...
    public void setSequenceNo(String sequenceNo) {
        ( (OutputCommandFinderComponent) getComponent() ).setSequenceNo(sequenceNo);
    }
    ...
    public String getSequenceNoDd() {
        return ( (OutputCommandFinderComponent) getComponent() ).getSequenceNoDd();
    }
    ...
    public void setSequenceNoDd(String sequenceNoDd) {
        ( (OutputCommandFinderComponent) getComponent() ).setSequenceNoDd(sequenceNoDd);
    }
    ...
    public String getOsPattern() {
        return ( (OutputCommandFinderComponent) getComponent() ).getOsPattern();
    }
    ...
    public void setOsPattern(String osPattern) {
        ( (OutputCommandFinderComponent) getComponent() ).setOsPattern(osPattern);
    }
    ...
    public String getOsPatternDd() {
        return ( (OutputCommandFinderComponent) getComponent() ).getOsPatternDd();
    }
    ...
    public void setOsPatternDd(String osPatternDd) {
        ( (OutputCommandFinderComponent) getComponent() ).setOsPatternDd(osPatternDd);
    }
    ...
    public String getCommandLine() {
        return ( (OutputCommandFinderComponent) getComponent() ).getCommandLine();
    }
    ...
    public void setCommandLine(String commandLine) {
        ( (OutputCommandFinderComponent) getComponent() ).setCommandLine(commandLine);
    }
    ...
    public String getCommandLineDd() {
        return ( (OutputCommandFinderComponent) getComponent() ).getCommandLineDd();
    }
    ...
    public void setCommandLineDd(String commandLineDd) {
        ( (OutputCommandFinderComponent) getComponent() ).setCommandLineDd(commandLineDd);
    }
    ...
    public String getCreatedOn() {
        return ( (OutputCommandFinderComponent) getComponent() ).getCreatedOn();
    }
    ...
    public void setCreatedOn(String createdOn) {
        ( (OutputCommandFinderComponent) getComponent() ).setCreatedOn(createdOn);
    }
    ...
    public String getCreatedOnDd() {
        return ( (OutputCommandFinderComponent) getComponent() ).getCreatedOnDd();
    }
    ...
    public void setCreatedOnDd(String createdOnDd) {
        ( (OutputCommandFinderComponent) getComponent() ).setCreatedOnDd(createdOnDd);
    }
    ...
    public String getCreatedBy() {
        return ( (OutputCommandFinderComponent) getComponent() ).getCreatedBy();
    }
    ...
    public void setCreatedBy(String createdBy) {
        ( (OutputCommandFinderComponent) getComponent() ).setCreatedBy(createdBy);
    }
    ...
    public String getCreatedByDd() {
        return ( (OutputCommandFinderComponent) getComponent() ).getCreatedByDd();
    }
    ...
    public void setCreatedByDd(String createdByDd) {
        ( (OutputCommandFinderComponent) getComponent() ).setCreatedByDd(createdByDd);
    }
    ...
    public String getLastChangedOn() {
        return ( (OutputCommandFinderComponent) getComponent() ).getLastChangedOn();
    }
    ...
    public void setLastChangedOn(String lastChangedOn) {
        ( (OutputCommandFinderComponent) getComponent() ).setLastChangedOn(lastChangedOn);
    }
    ...
    public String getLastChangedOnDd() {
        return ( (OutputCommandFinderComponent) getComponent() ).getLastChangedOnDd();
    }
    ...
    public void setLastChangedOnDd(String lastChangedOnDd) {
        ( (OutputCommandFinderComponent) getComponent() ).setLastChangedOnDd(lastChangedOnDd);
    }
    ...
    public String getLastChangedBy() {
        return ( (OutputCommandFinderComponent) getComponent() ).getLastChangedBy();
    }
    ...
    public void setLastChangedBy(String lastChangedBy) {
        ( (OutputCommandFinderComponent) getComponent() ).setLastChangedBy(lastChangedBy);
    }
    ...
    public String getLastChangedByDd() {
        return ( (OutputCommandFinderComponent) getComponent() ).getLastChangedByDd();
    }
    ...
    public void setLastChangedByDd(String lastChangedByDd) {
        ( (OutputCommandFinderComponent) getComponent() ).setLastChangedByDd(lastChangedByDd);
    }
