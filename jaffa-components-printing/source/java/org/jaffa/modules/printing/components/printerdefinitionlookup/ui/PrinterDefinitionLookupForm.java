...
import org.jaffa.modules.printing.components.printerdefinitionlookup.dto.PrinterDefinitionLookupOutRowDto;
...
// .//GEN-LAST:_imports
// .//GEN-BEGIN:_2_be
/** The FormBean class to support PrinterDefinitionLookup.
 */
public class PrinterDefinitionLookupForm extends LookupForm {

    private static Logger log = Logger.getLogger(PrinterDefinitionLookupForm.class);
    // .//GEN-END:_2_be
    ...
    public String getPrinterId() {
        return ( (PrinterDefinitionLookupComponent) getComponent() ).getPrinterId();
    }
    ...
    public void setPrinterId(String printerId) {
        ( (PrinterDefinitionLookupComponent) getComponent() ).setPrinterId(printerId);
    }
    ...
    public String getPrinterIdDd() {
        return ( (PrinterDefinitionLookupComponent) getComponent() ).getPrinterIdDd();
    }
    ...
    public void setPrinterIdDd(String printerIdDd) {
        ( (PrinterDefinitionLookupComponent) getComponent() ).setPrinterIdDd(printerIdDd);
    }
    ...
    public String getDescription() {
        return ( (PrinterDefinitionLookupComponent) getComponent() ).getDescription();
    }
    ...
    public void setDescription(String description) {
        ( (PrinterDefinitionLookupComponent) getComponent() ).setDescription(description);
    }
    ...
    public String getDescriptionDd() {
        return ( (PrinterDefinitionLookupComponent) getComponent() ).getDescriptionDd();
    }
    ...
    public void setDescriptionDd(String descriptionDd) {
        ( (PrinterDefinitionLookupComponent) getComponent() ).setDescriptionDd(descriptionDd);
    }
    ...
    public String getSiteCode() {
        return ( (PrinterDefinitionLookupComponent) getComponent() ).getSiteCode();
    }
    ...
    public void setSiteCode(String siteCode) {
        ( (PrinterDefinitionLookupComponent) getComponent() ).setSiteCode(siteCode);
    }
    ...
    public String getSiteCodeDd() {
        return ( (PrinterDefinitionLookupComponent) getComponent() ).getSiteCodeDd();
    }
    ...
    public void setSiteCodeDd(String siteCodeDd) {
        ( (PrinterDefinitionLookupComponent) getComponent() ).setSiteCodeDd(siteCodeDd);
    }
    ...
    public String getLocationCode() {
        return ( (PrinterDefinitionLookupComponent) getComponent() ).getLocationCode();
    }
    ...
    public void setLocationCode(String locationCode) {
        ( (PrinterDefinitionLookupComponent) getComponent() ).setLocationCode(locationCode);
    }
    ...
    public String getLocationCodeDd() {
        return ( (PrinterDefinitionLookupComponent) getComponent() ).getLocationCodeDd();
    }
    ...
    public void setLocationCodeDd(String locationCodeDd) {
        ( (PrinterDefinitionLookupComponent) getComponent() ).setLocationCodeDd(locationCodeDd);
    }
    ...
    public String getRealPrinterName() {
        return ( (PrinterDefinitionLookupComponent) getComponent() ).getRealPrinterName();
    }
    ...
    public void setRealPrinterName(String realPrinterName) {
        ( (PrinterDefinitionLookupComponent) getComponent() ).setRealPrinterName(realPrinterName);
    }
    ...
    public String getRealPrinterNameDd() {
        return ( (PrinterDefinitionLookupComponent) getComponent() ).getRealPrinterNameDd();
    }
    ...
    public void setRealPrinterNameDd(String realPrinterNameDd) {
        ( (PrinterDefinitionLookupComponent) getComponent() ).setRealPrinterNameDd(realPrinterNameDd);
    }
    ...
    public String getOutputType() {
        return ( (PrinterDefinitionLookupComponent) getComponent() ).getOutputType();
    }
    ...
    public void setOutputType(String outputType) {
        ( (PrinterDefinitionLookupComponent) getComponent() ).setOutputType(outputType);
    }
    ...
    public DropDownModel getOutputTypeWM() {
        ...
        if (outputTypeModel == null) {
            ...
            CodeHelperOutElementDto dto = ( (PrinterDefinitionLookupComponent) getComponent() ).getOutputTypeCodes();
    ...
    public String getOutputTypeDd() {
        return ( (PrinterDefinitionLookupComponent) getComponent() ).getOutputTypeDd();
    }
    ...
    public void setOutputTypeDd(String outputTypeDd) {
        ( (PrinterDefinitionLookupComponent) getComponent() ).setOutputTypeDd(outputTypeDd);
    }
    ...
    public String getScaleToPageSize() {
        return ( (PrinterDefinitionLookupComponent) getComponent() ).getScaleToPageSize();
    }
    ...
    public void setScaleToPageSize(String scaleToPageSize) {
        ( (PrinterDefinitionLookupComponent) getComponent() ).setScaleToPageSize(scaleToPageSize);
    }
    ...
    public DropDownModel getScaleToPageSizeWM() {
        ...
        if (scaleToPageSizeModel == null) {
            ...
            CodeHelperOutElementDto dto = ((PrinterDefinitionLookupComponent) getComponent()).getScaleToPageSizeCodes();
            if (dto != null && dto.getCodeHelperOutCodeDtoCount() > 0) {
                CodeHelperOutCodeDto[] codes = dto.getCodeHelperOutCodeDtos();
                for (int i = 0; i < codes.length; i++) {
                    CodeHelperOutCodeDto code = codes[i];
    ...
    public String getScaleToPageSizeDd() {
        return ( (PrinterDefinitionLookupComponent) getComponent() ).getScaleToPageSizeDd();
    }
    ...
    public void setScaleToPageSizeDd(String scaleToPageSizeDd) {
        ( (PrinterDefinitionLookupComponent) getComponent() ).setScaleToPageSizeDd(scaleToPageSizeDd);
    }
    ...
    public String getRemote() {
        return ( (PrinterDefinitionLookupComponent) getComponent() ).getRemote();
    }
    ...
    public void setRemote(String remote) {
        ( (PrinterDefinitionLookupComponent) getComponent() ).setRemote(remote);
    }
