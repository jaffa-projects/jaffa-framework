...
// .//GEN-LAST:_imports
// .//GEN-BEGIN:_2_be
/** The Action class for handling events related to FormGroupLookup.
 */
public class FormGroupLookupAction extends LookupAction {
    private static final Logger log = Logger.getLogger(FormGroupLookupAction.class);
    // .//GEN-END:_2_be
    ...
    public FormKey do_CreateFromCriteria_Clicked() {
        ...
        FormGroupLookupForm myForm = (FormGroupLookupForm) form;
        FormGroupLookupComponent myComp = (FormGroupLookupComponent) myForm.getComponent();
