 ...
 ******************************************************/
package org.jaffa.modules.printing.components.formusagelookup.ui;
...
import org.jaffa.modules.printing.components.formusagelookup.dto.FormUsageLookupOutDto;
import org.jaffa.modules.printing.components.formusagelookup.dto.FormUsageLookupOutRowDto;
...
// .//GEN-LAST:_imports
// .//GEN-BEGIN:_2_be
/** The FormBean class to support FormUsageLookup.
 */
public class FormUsageLookupForm extends LookupForm {

    private static Logger log = Logger.getLogger(FormUsageLookupForm.class);
    // .//GEN-END:_2_be
    ...
    public String getFormName() {
        return ( (FormUsageLookupComponent) getComponent() ).getFormName();
    }
    ...
    public void setFormName(String formName) {
        ( (FormUsageLookupComponent) getComponent() ).setFormName(formName);
    }
    ...
    public String getFormNameDd() {
        return ( (FormUsageLookupComponent) getComponent() ).getFormNameDd();
    }
    ...
    public void setFormNameDd(String formNameDd) {
        ( (FormUsageLookupComponent) getComponent() ).setFormNameDd(formNameDd);
    }
    ...
    public String getEventName() {
        return ( (FormUsageLookupComponent) getComponent() ).getEventName();
    }
    ...
    public void setEventName(String eventName) {
        ( (FormUsageLookupComponent) getComponent() ).setEventName(eventName);
    }
    ...
    public String getEventNameDd() {
        return ( (FormUsageLookupComponent) getComponent() ).getEventNameDd();
    }
    ...
    public void setEventNameDd(String eventNameDd) {
        ( (FormUsageLookupComponent) getComponent() ).setEventNameDd(eventNameDd);
    }
    ...
    public String getFormAlternate() {
        return ( (FormUsageLookupComponent) getComponent() ).getFormAlternate();
    }
    ...
    public void setFormAlternate(String formAlternate) {
        ( (FormUsageLookupComponent) getComponent() ).setFormAlternate(formAlternate);
    }
    ...
    public String getFormAlternateDd() {
        return ( (FormUsageLookupComponent) getComponent() ).getFormAlternateDd();
    }
    ...
    public void setFormAlternateDd(String formAlternateDd) {
        ( (FormUsageLookupComponent) getComponent() ).setFormAlternateDd(formAlternateDd);
    }
    ...
    public String getCopies() {
        return ( (FormUsageLookupComponent) getComponent() ).getCopies();
    }
    ...
    public void setCopies(String copies) {
        ( (FormUsageLookupComponent) getComponent() ).setCopies(copies);
    }
    ...
    public String getCopiesDd() {
        return ( (FormUsageLookupComponent) getComponent() ).getCopiesDd();
    }
    ...
    public void setCopiesDd(String copiesDd) {
        ( (FormUsageLookupComponent) getComponent() ).setCopiesDd(copiesDd);
    }
    ...
    public String getCreatedOn() {
        return ( (FormUsageLookupComponent) getComponent() ).getCreatedOn();
    }
    ...
    public void setCreatedOn(String createdOn) {
        ( (FormUsageLookupComponent) getComponent() ).setCreatedOn(createdOn);
    }
    ...
    public String getCreatedOnDd() {
        return ( (FormUsageLookupComponent) getComponent() ).getCreatedOnDd();
    }
    ...
    public void setCreatedOnDd(String createdOnDd) {
        ( (FormUsageLookupComponent) getComponent() ).setCreatedOnDd(createdOnDd);
    }
    ...
    public String getCreatedBy() {
        return ( (FormUsageLookupComponent) getComponent() ).getCreatedBy();
    }
    ...
    public void setCreatedBy(String createdBy) {
        ( (FormUsageLookupComponent) getComponent() ).setCreatedBy(createdBy);
    }
    ...
    public String getCreatedByDd() {
        return ( (FormUsageLookupComponent) getComponent() ).getCreatedByDd();
    }
    ...
    public void setCreatedByDd(String createdByDd) {
        ( (FormUsageLookupComponent) getComponent() ).setCreatedByDd(createdByDd);
    }
    ...
    public String getLastChangedOn() {
        return ( (FormUsageLookupComponent) getComponent() ).getLastChangedOn();
    }
    ...
    public void setLastChangedOn(String lastChangedOn) {
        ( (FormUsageLookupComponent) getComponent() ).setLastChangedOn(lastChangedOn);
    }
    ...
    public String getLastChangedOnDd() {
        return ( (FormUsageLookupComponent) getComponent() ).getLastChangedOnDd();
    }
    ...
    public void setLastChangedOnDd(String lastChangedOnDd) {
        ( (FormUsageLookupComponent) getComponent() ).setLastChangedOnDd(lastChangedOnDd);
    }
    ...
    public String getLastChangedBy() {
        return ( (FormUsageLookupComponent) getComponent() ).getLastChangedBy();
    }
    ...
    public void setLastChangedBy(String lastChangedBy) {
        ( (FormUsageLookupComponent) getComponent() ).setLastChangedBy(lastChangedBy);
    }
    ...
    public String getLastChangedByDd() {
        return ( (FormUsageLookupComponent) getComponent() ).getLastChangedByDd();
    }
    ...
    public void setLastChangedByDd(String lastChangedByDd) {
        ( (FormUsageLookupComponent) getComponent() ).setLastChangedByDd(lastChangedByDd);
    }
    ...
    public void populateRows(GridModel rows) {
        rows.clearRows();
        FormUsageLookupOutDto outputDto = (FormUsageLookupOutDto) ((FormUsageLookupComponent) getComponent()).getFinderOutDto();
        if (outputDto != null) {
            GridModelRow row;
            for (int i = 0; i < outputDto.getRowsCount(); i++) {
                FormUsageLookupOutRowDto rowDto = outputDto.getRows(i);
                row = rows.newRow();
