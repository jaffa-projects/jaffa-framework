 ...
 */
public class PrinterDefinitionMaintenanceAction extends MaintAction {

    private static final Logger log = Logger.getLogger(PrinterDefinitionMaintenanceAction.class);
    // .//GEN-END:_2_be
