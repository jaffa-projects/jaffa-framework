...
// .//GEN-LAST:_imports
// .//GEN-BEGIN:_2_be
/** The output for the FormTemplateFinder.
 */
public class FormTemplateFinderOutDto extends FinderOutDto {

    /** Holds an array of rows to be returned. */
    private List rows;

    /** Default Constructor.*/    
    public FormTemplateFinderOutDto() {
        rows = new ArrayList();
    }
    ...
    public FormTemplateFinderOutRowDto getRows(int index) {
        ...
        return (FormTemplateFinderOutRowDto) rows.get(index);
    }
    ...
    public FormTemplateFinderOutRowDto[] getRows() {
        return (FormTemplateFinderOutRowDto[]) rows.toArray(new FormTemplateFinderOutRowDto[0]);
    }
