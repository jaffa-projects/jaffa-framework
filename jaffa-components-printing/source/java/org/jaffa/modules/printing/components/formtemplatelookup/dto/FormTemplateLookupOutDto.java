 ...
 ******************************************************/
package org.jaffa.modules.printing.components.formtemplatelookup.dto;
...
// .//GEN-LAST:_imports
// .//GEN-BEGIN:_2_be
/** The output for the FormTemplateLookup.
 */
public class FormTemplateLookupOutDto extends FinderOutDto {

    /** Holds an array of rows to be returned. */
    private List rows;

    /** Default Constructor.*/    
    public FormTemplateLookupOutDto() {
        rows = new ArrayList();
    }
    ...
    public FormTemplateLookupOutRowDto getRows(int index) {
        ...
        return (FormTemplateLookupOutRowDto) rows.get(index);
    }
    ...
    public FormTemplateLookupOutRowDto[] getRows() {
        return (FormTemplateLookupOutRowDto[]) rows.toArray(new FormTemplateLookupOutRowDto[0]);
    }
