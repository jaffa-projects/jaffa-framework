...
// .//GEN-LAST:_imports
// .//GEN-BEGIN:_2_be
/** The Action class for handling events related to FormUsageLookup.
 */
public class FormUsageLookupAction extends LookupAction {
    private static final Logger log = Logger.getLogger(FormUsageLookupAction.class);
    // .//GEN-END:_2_be
