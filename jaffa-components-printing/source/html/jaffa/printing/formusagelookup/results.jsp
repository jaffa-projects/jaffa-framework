...
<Portlet:UserGrid field="rows" userGridId="jaffa_printing_formUsageLookup" detail="<%= !inMultiSelectLookupMode.booleanValue() %>">
  ...
  <Portlet:Property field='formName' propertyClass='org.jaffa.modules.printing.components.formusagelookup.dto.FormUsageLookupOutRowDto'>
    <Portlet:UserGridColumn dataType="CaseInsensitiveString" label='[label.Jaffa.Printing.FormGroup.FormName]'>
      <Portlet:Text />
    </Portlet:UserGridColumn>
  </Portlet:Property>
  <Portlet:Property field='eventName' propertyClass='org.jaffa.modules.printing.components.formusagelookup.dto.FormUsageLookupOutRowDto'>
    <Portlet:UserGridColumn dataType="CaseInsensitiveString" label='[label.Jaffa.Printing.FormEvent.EventName]'>
      <Portlet:Text />
    </Portlet:UserGridColumn>
  </Portlet:Property>
  <Portlet:Property field='formAlternate' propertyClass='org.jaffa.modules.printing.components.formusagelookup.dto.FormUsageLookupOutRowDto'>
    <Portlet:UserGridColumn dataType="CaseInsensitiveString" label='[label.Jaffa.Printing.FormDefinition.FormAlternate]'>
      <Portlet:Text />
    </Portlet:UserGridColumn>
  </Portlet:Property>
  <Portlet:Property field='copies' propertyClass='org.jaffa.modules.printing.components.formusagelookup.dto.FormUsageLookupOutRowDto'>
    <Portlet:UserGridColumn dataType="Number" label='[label.Jaffa.Printing.FormUsage.Copies]'>
      <Portlet:Text />
    </Portlet:UserGridColumn>
  </Portlet:Property>
  <Portlet:Property field='createdOn' propertyClass='org.jaffa.modules.printing.components.formusagelookup.dto.FormUsageLookupOutRowDto'>
    <Portlet:UserGridColumn dataType="Date" label='[label.Jaffa.Common.CreatedOn]'>
      <Portlet:Text />
    </Portlet:UserGridColumn>
  </Portlet:Property>
  <Portlet:Property field='createdBy' propertyClass='org.jaffa.modules.printing.components.formusagelookup.dto.FormUsageLookupOutRowDto'>
    <Portlet:UserGridColumn dataType="CaseInsensitiveString" label='[label.Jaffa.Common.CreatedBy]'>
      <Portlet:Text />
    </Portlet:UserGridColumn>
  </Portlet:Property>
  <Portlet:Property field='lastChangedOn' propertyClass='org.jaffa.modules.printing.components.formusagelookup.dto.FormUsageLookupOutRowDto'>
    <Portlet:UserGridColumn dataType="Date" label='[label.Jaffa.Common.LastChangedOn]'>
      <Portlet:Text />
    </Portlet:UserGridColumn>
  </Portlet:Property>
  <Portlet:Property field='lastChangedBy' propertyClass='org.jaffa.modules.printing.components.formusagelookup.dto.FormUsageLookupOutRowDto'>
