...
<Portlet:UserGrid field="rows" userGridId="jaffa_printing_formTemplateFinder" outputType="<%= outputType %>" detail="true" target="_blank">
  <Portlet:Property field='formId' propertyClass='org.jaffa.modules.printing.components.formtemplatefinder.dto.FormTemplateFinderOutRowDto'>
    <Portlet:UserGridColumn dataType="Number" label='[label.Jaffa.Printing.FormDefinition.FormId]'>
      <Portlet:Text />
    </Portlet:UserGridColumn>
  </Portlet:Property>
  <Portlet:Property field='templateData' propertyClass='org.jaffa.modules.printing.components.formtemplatefinder.dto.FormTemplateFinderOutRowDto'>
    <Portlet:UserGridColumn dataType="CaseInsensitiveString" label='[label.Jaffa.Printing.FormTemplate.TemplateData]'>
      <Portlet:Text />
    </Portlet:UserGridColumn>
  </Portlet:Property>
  <Portlet:Property field='layoutData' propertyClass='org.jaffa.modules.printing.components.formtemplatefinder.dto.FormTemplateFinderOutRowDto'>
