...
<Portlet:UserGrid field="rows" userGridId="jaffa_printing_formTemplateLookup" detail="<%= !inMultiSelectLookupMode.booleanValue() %>">
  ...
  <Portlet:Property field='formId' propertyClass='org.jaffa.modules.printing.components.formtemplatelookup.dto.FormTemplateLookupOutRowDto'>
    <Portlet:UserGridColumn dataType="Number" label='[label.Jaffa.Printing.FormDefinition.FormId]'>
      <Portlet:Text />
    </Portlet:UserGridColumn>
  </Portlet:Property>
  <Portlet:Property field='templateData' propertyClass='org.jaffa.modules.printing.components.formtemplatelookup.dto.FormTemplateLookupOutRowDto'>
    <Portlet:UserGridColumn dataType="CaseInsensitiveString" label='[label.Jaffa.Printing.FormTemplate.TemplateData]'>
      <Portlet:Text />
    </Portlet:UserGridColumn>
  </Portlet:Property>
  <Portlet:Property field='layoutData' propertyClass='org.jaffa.modules.printing.components.formtemplatelookup.dto.FormTemplateLookupOutRowDto'>
    <Portlet:UserGridColumn dataType="CaseInsensitiveString" label='[label.Jaffa.Printing.FormTemplate.LayoutData]'>
      <Portlet:Text />
    </Portlet:UserGridColumn>
  </Portlet:Property>
    ...
    <Portlet:UserGridColumn label="[label.Jaffa.Widgets.Button.Action]">
      ...
      <Portlet:ComponentGuard name="Jaffa.Printing.FormTemplateViewer">
      ...
      <Portlet:ComponentGuard name="Jaffa.Printing.FormTemplateMaintenance">
