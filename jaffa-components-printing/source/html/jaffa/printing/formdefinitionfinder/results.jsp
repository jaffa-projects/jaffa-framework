...
<Portlet:UserGrid field="rows" userGridId="jaffa_printing_formDefinitionFinder" outputType="<%= outputType %>" detail="true" target="_blank">
  <Portlet:Property field='formName' propertyClass='org.jaffa.modules.printing.components.formdefinitionfinder.dto.FormDefinitionFinderOutRowDto'>
  ...
  <Portlet:Property field='formAlternate' propertyClass='org.jaffa.modules.printing.components.formdefinitionfinder.dto.FormDefinitionFinderOutRowDto'>
    <Portlet:UserGridColumn dataType="CaseInsensitiveString" label='[label.Jaffa.Printing.FormDefinition.FormAlternate]'>
      <Portlet:Text />
    </Portlet:UserGridColumn>
  </Portlet:Property>
  <Portlet:Property field='formVariation' propertyClass='org.jaffa.modules.printing.components.formdefinitionfinder.dto.FormDefinitionFinderOutRowDto'>
    <Portlet:UserGridColumn dataType="CaseInsensitiveString" label='[label.Jaffa.Printing.FormDefinition.FormVariation]'>
      <Portlet:Text />
    </Portlet:UserGridColumn>
  </Portlet:Property>
  <Portlet:Property field='description' propertyClass='org.jaffa.modules.printing.components.formdefinitionfinder.dto.FormDefinitionFinderOutRowDto'>
    <Portlet:UserGridColumn dataType="CaseInsensitiveString" label='[label.Jaffa.Printing.FormDefinition.Description]'>
      <Portlet:Text />
    </Portlet:UserGridColumn>
  </Portlet:Property>
  <Portlet:Property field='formTemplate' propertyClass='org.jaffa.modules.printing.components.formdefinitionfinder.dto.FormDefinitionFinderOutRowDto'>
    <Portlet:UserGridColumn dataType="CaseInsensitiveString" label='[label.Jaffa.Printing.FormDefinition.FormTemplate]'>
      <Portlet:Text />
    </Portlet:UserGridColumn>
  </Portlet:Property>
  <Portlet:Property field='outputType' propertyClass='org.jaffa.modules.printing.components.formdefinitionfinder.dto.FormDefinitionFinderOutRowDto'>
