...
// .//GEN-LAST:_imports
// .//GEN-BEGIN:_2_be
/** The output for the AttachmentFinder.
 */
public class AttachmentFinderOutDto extends FinderOutDto {

    /** Holds an array of rows to be returned. */
    private List rows;

    /** Default Constructor.*/    
    public AttachmentFinderOutDto() {
        rows = new ArrayList();
    }
    ...
    public AttachmentFinderOutRowDto getRows(int index) {
        ...
        return (AttachmentFinderOutRowDto) rows.get(index);
    }
    ...
    public AttachmentFinderOutRowDto[] getRows() {
        return (AttachmentFinderOutRowDto[]) rows.toArray(new AttachmentFinderOutRowDto[0]);
    }
