 ...
 ******************************************************/
package org.jaffa.components.attachment.components.attachmentfinder.tx;
...
// .//GEN-LAST:_imports
// .//GEN-BEGIN:_2_be
/** Finder for Attachment objects.
*/
public class AttachmentFinderTx implements IAttachmentFinder {

    private static Logger log = Logger.getLogger(AttachmentFinderTx.class);
     ...
     */
    public AttachmentFinderOutDto find(AttachmentFinderInDto input)
    throws FrameworkException, ApplicationExceptions {
        ...
        try {
            ...
            AttachmentFinderOutDto output = buildDto(uow, results, input);
    ...
    private AttachmentFinderOutDto buildDto(UOW uow, Collection results, AttachmentFinderInDto input)
    throws UOWException {
