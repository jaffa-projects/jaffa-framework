...
import org.jaffa.components.attachment.components.attachmentfinder.IAttachmentFinder;
import org.jaffa.components.attachment.components.attachmentfinder.dto.AttachmentFinderInDto;
...
// .//GEN-LAST:_imports
// .//GEN-BEGIN:_2_be
/** The controller for the AttachmentFinder.
 */
public class AttachmentFinderComponent extends FinderComponent2 {

    private static Logger log = Logger.getLogger(AttachmentFinderComponent.class);
    ...
    private IAttachmentFinder m_tx = null;
    ...
    public AttachmentFinderComponent() {
        super();
    ...
    protected String getCriteriaFormName() {
        return "jaffa_attachment_attachmentFinderCriteria";
    }
    ...
    protected String getResultsFormName() {
        return "jaffa_attachment_attachmentFinderResults";
    }
    ...
    protected String getConsolidatedCriteriaAndResultsFormName() {
        return "jaffa_attachment_attachmentFinderConsolidatedCriteriaAndResults";
    }
    ...
    protected String getExcelFormName() {
        return "jaffa_attachment_attachmentFinderExcelResults";
    }
    ...
    protected String getXmlFormName() {
        return "jaffa_attachment_attachmentFinderXmlResults";
    }
    ...
    protected FinderOutDto doInquiry() throws ApplicationExceptions, FrameworkException {
        ...
        AttachmentFinderInDto inputDto = new AttachmentFinderInDto();
        ...
        // perform the inquiry
        if (m_tx == null)
            m_tx = (IAttachmentFinder) Factory.createObject(IAttachmentFinder.class);
    ...
    public FormKey createObject(FormKey formKey) throws ApplicationExceptions, FrameworkException {
        ...
        if (getSerializedKey() != null && (getSerializedKeyDd() == null || getSerializedKeyDd().equals(CriteriaField.RELATIONAL_EQUALS)))
            m_createComponent.setSerializedKey(getSerializedKey());
