...
// .//GEN-LAST:_imports
// .//GEN-BEGIN:_2_be
/** The Action class for handling events related to AttachmentFinder.
 */
public class AttachmentFinderAction extends FinderAction {
    private static final Logger log = Logger.getLogger(AttachmentFinderAction.class);
