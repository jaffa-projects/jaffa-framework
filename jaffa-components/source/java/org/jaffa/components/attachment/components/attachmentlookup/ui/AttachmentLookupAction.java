...
// .//GEN-LAST:_imports
// .//GEN-BEGIN:_2_be
/** The Action class for handling events related to AttachmentLookup.
 */
public class AttachmentLookupAction extends LookupAction {
    private static final Logger log = Logger.getLogger(AttachmentLookupAction.class);
    // .//GEN-END:_2_be
