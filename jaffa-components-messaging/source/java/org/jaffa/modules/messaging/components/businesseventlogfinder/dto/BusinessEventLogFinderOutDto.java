...
// .//GEN-LAST:_imports
// .//GEN-BEGIN:_2_be
/** The output for the BusinessEventLogFinder.
 */
public class BusinessEventLogFinderOutDto extends FinderOutDto {

    /** Holds an array of rows to be returned. */
    private List rows;

    /** Default Constructor.*/    
    public BusinessEventLogFinderOutDto() {
        rows = new ArrayList();
    }
    ...
    public BusinessEventLogFinderOutRowDto getRows(int index) {
        ...
        return (BusinessEventLogFinderOutRowDto) rows.get(index);
    }
    ...
    public BusinessEventLogFinderOutRowDto[] getRows() {
        return (BusinessEventLogFinderOutRowDto[]) rows.toArray(new BusinessEventLogFinderOutRowDto[0]);
    }
