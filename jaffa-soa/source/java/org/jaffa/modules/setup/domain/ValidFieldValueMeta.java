...
public class ValidFieldValueMeta {
    ...
    public static final FieldMetaData META_TABLE_NAME = new StringFieldMetaData(TABLE_NAME, "[label.Jaffa.Setup.ValidFieldValue.TableName]", Boolean.TRUE, null, new Integer(20), FieldMetaData.MIXED_CASE);

    /** A constant which holds the meta information for the FieldName field.*/
    public static final FieldMetaData META_FIELD_NAME = new StringFieldMetaData(FIELD_NAME, "[label.Jaffa.Setup.ValidFieldValue.FieldName]", Boolean.TRUE, null, new Integer(30), FieldMetaData.MIXED_CASE);

    /** A constant which holds the meta information for the LegalValue field.*/
    public static final FieldMetaData META_LEGAL_VALUE = new StringFieldMetaData(LEGAL_VALUE, "[label.Jaffa.Setup.ValidFieldValue.LegalValue]", Boolean.TRUE, null, new Integer(200), FieldMetaData.MIXED_CASE);

    /** A constant which holds the meta information for the Description field.*/
    public static final FieldMetaData META_DESCRIPTION = new StringFieldMetaData(DESCRIPTION, "[label.Jaffa.Setup.ValidFieldValue.Description]", Boolean.FALSE, null, new Integer(80), FieldMetaData.MIXED_CASE);
    ...
    public static final FieldMetaData META_VERSION_NUMBER = new IntegerFieldMetaData(VERSION_NUMBER, "[label.Jaffa.Setup.ValidFieldValue.VersionNumber]", Boolean.FALSE, null, null, null, new Integer(10));
