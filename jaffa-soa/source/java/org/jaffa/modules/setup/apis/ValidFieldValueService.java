package org.jaffa.modules.setup.apis;

import org.apache.log4j.Logger;
import org.jaffa.modules.setup.apis.data.ValidFieldValueCriteria;
import org.jaffa.modules.setup.apis.data.ValidFieldValueGraph;
import org.jaffa.modules.setup.apis.data.ValidFieldValueQueryResponse;
import org.jaffa.modules.setup.apis.data.ValidFieldValueUpdateResponse;
 ...
 */
public class ValidFieldValueService extends GraphService<ValidFieldValueCriteria, ValidFieldValueGraph, ValidFieldValueQueryResponse, ValidFieldValueUpdateResponse, TransformationHandler> {

    private static Logger log = Logger.getLogger(ValidFieldValueService.class);
