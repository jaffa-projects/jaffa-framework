...
// .//GEN-LAST:imports
// .//GEN-BEGIN:2_be
/** This class has the meta information for the TransactionDependency persistent class.
 */
public class TransactionDependencyMeta {
    
    // domain-object class name
    private static String m_name = "org.jaffa.transaction.domain.TransactionDependency";
    ...
    static {
        ...
        m_keyFields.add(META_DEPENDS_ON_ID);
    }
