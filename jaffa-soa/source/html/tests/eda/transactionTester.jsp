<%--
This test will create the specified number of multi-threaded transactions, add them all to one UOW and commit the UOW.
Once the UOW is committed, all of the transactions will be sent for consumption.
--%>
<%@page import="org.jaffa.transaction.tester.TestMessage,org.jaffa.transaction.tester.TestConsumer,org.jaffa.persistence.UOW"%>
...
<html>
  <head>
    <title>Transaction Tester Multi-threaded</title>
     <style>
      body {
      color: black;
      font-size: 10pt;
  ...
  <body>
    <form action="transactionTester.jsp" method="post">
      <h2>Transaction Tester Multi-threaded</h2>
      <%
