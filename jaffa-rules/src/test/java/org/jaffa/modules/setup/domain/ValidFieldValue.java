...
import org.jaffa.persistence.exceptions.UpdatePrimaryKeyException;
...
public class ValidFieldValue extends Persistent {
     ...
     */
    public static boolean exists(UOW uow, String tableName, String fieldName, String legalValue) throws FrameworkException {
     ...
     * @throws FrameworkException Indicates some system error
     */
    public static ValidFieldValue findByPK(UOW uow, String tableName, String fieldName, String legalValue) throws FrameworkException {
        boolean localUow = false;
        try {
            if (uow == null || !uow.isActive()) {
                uow = new UOW();
     ...
     */
    public static Criteria findByPKCriteria(String tableName, String fieldName, String legalValue) {
    ...
    public String toString() {
        ...
        if (m_tableName != null) buf.append(m_tableName);
        buf.append("</tableName>");
        buf.append("<fieldName>");
        if (m_fieldName != null) buf.append(m_fieldName);
        buf.append("</fieldName>");
        buf.append("<legalValue>");
        if (m_legalValue != null) buf.append(m_legalValue);
        buf.append("</legalValue>");
        buf.append("<description>");
        if (m_description != null) buf.append(m_description);
        buf.append("</description>");
        buf.append("<remarks>");
        if (m_remarks != null) buf.append(m_remarks);
        buf.append("</remarks>");
