...
// .//GEN-LAST:_imports
// .//GEN-BEGIN:_2_be
/** The output for the UserRequestLookup.
 */
public class UserRequestLookupOutDto extends FinderOutDto {

    /** Holds an array of rows to be returned. */
    private List rows;

    /** Default Constructor.*/    
    public UserRequestLookupOutDto() {
        rows = new ArrayList();
    }
    ...
    public UserRequestLookupOutRowDto getRows(int index) {
        ...
        return (UserRequestLookupOutRowDto) rows.get(index);
    }
    ...
    public UserRequestLookupOutRowDto[] getRows() {
        return (UserRequestLookupOutRowDto[]) rows.toArray(new UserRequestLookupOutRowDto[0]);
    }
