...
// .//GEN-LAST:_imports
// .//GEN-BEGIN:_2_be
/** The FormBean class to support UserLookup.
 */
public class UserLookupForm extends LookupForm {

    private static Logger log = Logger.getLogger(UserLookupForm.class);
    // .//GEN-END:_2_be
    ...
    public String getUserName() {
        return ( (UserLookupComponent) getComponent() ).getUserName();
    }
    ...
    public void setUserName(String userName) {
        ( (UserLookupComponent) getComponent() ).setUserName(userName);
    }
    ...
    public String getUserNameDd() {
        return ( (UserLookupComponent) getComponent() ).getUserNameDd();
    }
    ...
    public void setUserNameDd(String userNameDd) {
        ( (UserLookupComponent) getComponent() ).setUserNameDd(userNameDd);
    }
    ...
    public String getFirstName() {
        return ( (UserLookupComponent) getComponent() ).getFirstName();
    }
    ...
    public void setFirstName(String firstName) {
        ( (UserLookupComponent) getComponent() ).setFirstName(firstName);
    }
    ...
    public String getFirstNameDd() {
        return ( (UserLookupComponent) getComponent() ).getFirstNameDd();
    }
    ...
    public void setFirstNameDd(String firstNameDd) {
        ( (UserLookupComponent) getComponent() ).setFirstNameDd(firstNameDd);
    }
    ...
    public String getLastName() {
        return ( (UserLookupComponent) getComponent() ).getLastName();
    }
    ...
    public void setLastName(String lastName) {
        ( (UserLookupComponent) getComponent() ).setLastName(lastName);
    }
    ...
    public String getLastNameDd() {
        return ( (UserLookupComponent) getComponent() ).getLastNameDd();
    }
    ...
    public void setLastNameDd(String lastNameDd) {
        ( (UserLookupComponent) getComponent() ).setLastNameDd(lastNameDd);
    }
    ...
    public String getStatus() {
        return ( (UserLookupComponent) getComponent() ).getStatus();
    }
    ...
    public void setStatus(String status) {
        ( (UserLookupComponent) getComponent() ).setStatus(status);
    }
    ...
    public String getEMailAddress() {
        return ( (UserLookupComponent) getComponent() ).getEMailAddress();
    }
    ...
    public void setEMailAddress(String eMailAddress) {
        ( (UserLookupComponent) getComponent() ).setEMailAddress(eMailAddress);
    }
    ...
    public String getEMailAddressDd() {
        return ( (UserLookupComponent) getComponent() ).getEMailAddressDd();
    }
    ...
    public void setEMailAddressDd(String eMailAddressDd) {
        ( (UserLookupComponent) getComponent() ).setEMailAddressDd(eMailAddressDd);
    }
    ...
    public void populateRows(GridModel rows) {
        rows.clearRows();
        UserLookupOutDto outputDto = (UserLookupOutDto) ((UserLookupComponent) getComponent()).getFinderOutDto();
        if (outputDto != null) {
            GridModelRow row;
            for (int i = 0; i < outputDto.getRowsCount(); i++) {
                UserLookupOutRowDto rowDto = outputDto.getRows(i);
                row = rows.newRow();
