...
// .//GEN-LAST:_imports
// .//GEN-BEGIN:_2_be
/** The Action class for handling events related to UserRequestFinder.
 */
public class UserRequestFinderAction extends FinderAction {
    private static final Logger log = Logger.getLogger(UserRequestFinderAction.class);
