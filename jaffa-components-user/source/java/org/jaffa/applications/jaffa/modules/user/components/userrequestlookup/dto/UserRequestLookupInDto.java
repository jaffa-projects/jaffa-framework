 ...
 ******************************************************/
package org.jaffa.applications.jaffa.modules.user.components.userrequestlookup.dto;
...
// .//GEN-LAST:_imports
// .//GEN-BEGIN:_2_be
/** The input for the UserRequestLookup.
 */
public class UserRequestLookupInDto extends FinderInDto {

    /** Holds value of property headerDto. */
    private HeaderDto headerDto;

    /** Holds value of property requestId. */
    private IntegerCriteriaField requestId;
    ...
    private DateTimeCriteriaField processedDatetime;

    /** Holds value of property processedUserId. */
    private StringCriteriaField processedUserId;
    ...
    public String toString() {
        ...
        buf.append("<UserRequestLookupInDto>");
        ...
        buf.append("<password>"); if (password != null) buf.append(password); buf.append("</password>");
