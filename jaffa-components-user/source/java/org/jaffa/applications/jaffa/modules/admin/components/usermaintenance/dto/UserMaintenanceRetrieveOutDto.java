 ...
 */
public class UserMaintenanceRetrieveOutDto {
    ...
    /** Holds value of property autoPassword. */
    private java.lang.Boolean autoPassword;

    /** Holds value of property notifyUser. */
    private java.lang.Boolean notifyUser;
    ...
    /** Default Constructor.*/    
    public UserMaintenanceRetrieveOutDto() {
    ...
    public String toString() {
        ...
        buf.append("<UserMaintenanceRetrieveOutDto>");
        ...
        buf.append("<autoPassword>"); if (autoPassword != null) buf.append(autoPassword); buf.append("</autoPassword>");
        buf.append("<notifyUser>"); if (notifyUser != null) buf.append(notifyUser); buf.append("</notifyUser>");
