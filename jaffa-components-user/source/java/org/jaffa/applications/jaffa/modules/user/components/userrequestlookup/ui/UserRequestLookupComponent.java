...
// .//GEN-LAST:_imports
// .//GEN-BEGIN:_2_be
/** The controller for the UserRequestLookup.
 */
public class UserRequestLookupComponent extends LookupComponent2 {

    private static Logger log = Logger.getLogger(UserRequestLookupComponent.class);
    ...
    private IUserRequestLookup m_tx = null;
    ...
    public UserRequestLookupComponent() {
        super();
    ...
    protected String getCriteriaFormName() {
        return "user_userRequestLookupCriteria";
    }
    ...
    protected String getResultsFormName() {
        return "user_userRequestLookupResults";
    }
    ...
    protected String getConsolidatedCriteriaAndResultsFormName() {
        return "user_userRequestLookupConsolidatedCriteriaAndResults";
    }
    // .//GEN-END:_2_be
    ...
    protected FinderOutDto doInquiry() throws ApplicationExceptions, FrameworkException {
        ...
        UserRequestLookupInDto inputDto = new UserRequestLookupInDto();
        ...
        // perform the inquiry
        if (m_tx == null)
            m_tx = (IUserRequestLookup) Factory.createObject(IUserRequestLookup.class);
