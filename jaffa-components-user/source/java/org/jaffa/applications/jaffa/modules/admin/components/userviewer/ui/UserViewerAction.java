 ...
 */
public class UserViewerAction extends ActionBase {

    private static final Logger log = Logger.getLogger(UserViewerAction.class);
    ...
    public FormKey do_Close_Clicked() {
        ...
        return ((UserViewerForm) form).getComponent().quitAndReturnToCallingScreen();
    }
    ...
    public FormKey do_Update_Clicked() {
        ...
        UserViewerForm myForm = (UserViewerForm) form;
        UserViewerComponent myComp = (UserViewerComponent) myForm.getComponent();
        try {
