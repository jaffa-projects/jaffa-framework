...
// .//GEN-LAST:_imports
// .//GEN-BEGIN:_2_be
/** The Action class for handling events related to UserFinder.
 */
public class UserFinderAction extends FinderAction {
    private static final Logger log = Logger.getLogger(UserFinderAction.class);
