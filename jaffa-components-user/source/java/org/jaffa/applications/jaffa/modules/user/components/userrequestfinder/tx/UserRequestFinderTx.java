 ...
 ******************************************************/
package org.jaffa.applications.jaffa.modules.user.components.userrequestfinder.tx;
...
// .//GEN-LAST:_imports
// .//GEN-BEGIN:_2_be
/** Finder for UserRequest objects.
*/
public class UserRequestFinderTx implements IUserRequestFinder {

    private static Logger log = Logger.getLogger(UserRequestFinderTx.class);
     ...
     */
    public UserRequestFinderOutDto find(UserRequestFinderInDto input)
    throws FrameworkException, ApplicationExceptions {
        ...
        try {
            ...
            UserRequestFinderOutDto output = buildDto(uow, results, input);
    ...
    private UserRequestFinderOutDto buildDto(UOW uow, Collection results, UserRequestFinderInDto input)
    throws UOWException {
