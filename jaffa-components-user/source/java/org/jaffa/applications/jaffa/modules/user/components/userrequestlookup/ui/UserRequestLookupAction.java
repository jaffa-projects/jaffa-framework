...
// .//GEN-LAST:_imports
// .//GEN-BEGIN:_2_be
/** The Action class for handling events related to UserRequestLookup.
 */
public class UserRequestLookupAction extends LookupAction {
    private static final Logger log = Logger.getLogger(UserRequestLookupAction.class);
    // .//GEN-END:_2_be
    ...
    public FormKey do_Rows_View_Clicked(String rowNum) {
        ...
        if (selectedRow != null) {
            try {
                ...
                fk = myComp.viewObject((java.lang.Long) selectedRow.get("requestId"));
            } catch (ApplicationExceptions e){
                if (log.isDebugEnabled())
    ...
    public FormKey do_Rows_Delete_Clicked(String rowNum) {
        ...
        try {
            ...
            if (selectedRow != null) {
                ...
                fk = myComp.deleteObject((java.lang.Long) selectedRow.get("requestId"));
            }
        } catch (ApplicationExceptions e){
            if (log.isDebugEnabled())
