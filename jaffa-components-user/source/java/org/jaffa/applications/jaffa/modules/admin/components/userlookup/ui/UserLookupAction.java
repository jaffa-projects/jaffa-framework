...
// .//GEN-LAST:_imports
// .//GEN-BEGIN:_2_be
/** The Action class for handling events related to UserLookup.
 */
public class UserLookupAction extends LookupAction {
    private static final Logger log = Logger.getLogger(UserLookupAction.class);
    // .//GEN-END:_2_be
