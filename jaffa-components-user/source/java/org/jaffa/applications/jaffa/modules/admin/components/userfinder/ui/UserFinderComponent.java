...
import org.jaffa.applications.jaffa.modules.admin.components.userfinder.IUserFinder;
import org.jaffa.applications.jaffa.modules.admin.components.userfinder.dto.UserFinderInDto;
...
// .//GEN-LAST:_imports
// .//GEN-BEGIN:_2_be
/** The controller for the UserFinder.
 */
public class UserFinderComponent extends FinderComponent2 {

    private static Logger log = Logger.getLogger(UserFinderComponent.class);
    ...
    protected String getCriteriaFormName() {
        return "admin_userFinderCriteria";
    }
    ...
    protected String getResultsFormName() {
        return "admin_userFinderResults";
    }
    ...
    protected String getConsolidatedCriteriaAndResultsFormName() {
        return "admin_userFinderConsolidatedCriteriaAndResults";
    }
    ...
    protected String getExcelFormName() {
        return "admin_userFinderExcelResults";
    }
    ...
    protected String getXmlFormName() {
        return "admin_userFinderXmlResults";
    }
    ...
    protected FinderOutDto doInquiry() throws ApplicationExceptions, FrameworkException {
        ...
        // perform the inquiry
        if (m_tx == null)
            m_tx = (IUserFinder) Factory.createObject(IUserFinder.class);
