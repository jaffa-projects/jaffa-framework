 ...
 ******************************************************/
package org.jaffa.applications.jaffa.modules.admin.components.userfinder.tx;
...
// .//GEN-LAST:_imports
// .//GEN-BEGIN:_2_be
/** Finder for User objects.
*/
public class UserFinderTx implements IUserFinder {

    private static Logger log = Logger.getLogger(UserFinderTx.class);
     ...
     */
    public UserFinderOutDto find(UserFinderInDto input)
    ...
    private UserFinderOutDto buildDto(UOW uow, Collection results, UserFinderInDto input)
    throws UOWException {
