 ...
 */
public class UserRequestViewerAction extends ActionBase {

    private static final Logger log = Logger.getLogger(UserRequestViewerAction.class);
    ...
    public FormKey do_Close_Clicked() {
        ...
        return ((UserRequestViewerForm) form).getComponent().quitAndReturnToCallingScreen();
    }
    ...
    public FormKey do_Update_Clicked() {
        ...
        UserRequestViewerForm myForm = (UserRequestViewerForm) form;
        UserRequestViewerComponent myComp = (UserRequestViewerComponent) myForm.getComponent();
        try {
