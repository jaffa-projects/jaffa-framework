 ...
 ******************************************************/
package org.jaffa.applications.jaffa.modules.admin.components.userlookup.dto;
...
// .//GEN-LAST:_imports
// .//GEN-BEGIN:_2_be
/** The output for the UserLookup.
 */
public class UserLookupOutDto extends FinderOutDto {

    /** Holds an array of rows to be returned. */
    private List rows;

    /** Default Constructor.*/    
    public UserLookupOutDto() {
        rows = new ArrayList();
    }
    ...
    public UserLookupOutRowDto getRows(int index) {
        ...
        return (UserLookupOutRowDto) rows.get(index);
    }
    ...
    public UserLookupOutRowDto[] getRows() {
        return (UserLookupOutRowDto[]) rows.toArray(new UserLookupOutRowDto[0]);
    }
