...
<!-- Start of '/jaffa/nonsecure/requestpassword/contextNav.jsp' -->
  ...
  <TR align='middle'>
    <TD>
      ...
      <table class='contextNavBody' cellspacing='0' cellpadding='0' width='100%'>
        ...
        <logic:equal property='currentScreenCounter' name='<%= TagHelper.getFormName(pageContext) %>' value='0'>
          <TR><TD><img src='jaffa/imgs/icons/finish.gif'><Portlet:Button field='finish' type='link' label='[label.Jaffa.Widgets.Button.Finish]' guarded='true'/></TD></TR>
          <TR><TD><img src='jaffa/imgs/icons/cancel.gif'><Portlet:Button field='cancel' type='link' label='[label.Jaffa.Widgets.Button.Cancel]' guarded='true'/></TD></TR>
          <TR><TD><img src='jaffa/imgs/icons/clear.gif'><Portlet:Button field='clear' type='link' label='[label.Jaffa.Widgets.Button.Clear]' guarded='true'/></TD></TR>
        </logic:equal>
...
<!-- End of '/jaffa/nonsecure/requestpassword/contextNav.jsp' -->
